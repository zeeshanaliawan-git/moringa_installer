...
--
-- Host: localhost    Database: cleandb_prod_shop
-- ------------------------------------------------------
...
INSERT INTO `config` VALUES ('sso_app_id','',NULL),('empty_service_id','',NULL),('UPLOAD_FOLDER','/home/asimina/tomcat/webapps/asimina_prodshop/WEB-INF/upload_file',NULL),('EXEC_FOLDER','/home/asimina/tomcat/webapps/asimina_prodshop/WEB-INF/classes',NULL),('CATALOG_DB','cleandb_prod_catalog',NULL),('MAIL_UPLOAD_PATH','',NULL),('CATALOG_URL','/asimina_prodcatalog/',NULL),('SEMAPHORE','D006',NULL),('PORTAL_DB','cleandb_prod_portal',NULL),('EXTERNAL_PORTAL_LINK','/asimina_prodportal/',NULL),('COOKIE_PREFIX','asimina_prodcatalog',NULL),('ABSENCE_PRODUCT_NAME','Absence Product',NULL),('IS_PROD_SHOP','1',NULL),('APP_NAME','Prod Shop',NULL),('COMMONS_DB','cleandb_commons',NULL),('URL_REQUETEUR','',NULL),('WAIT_TIMEOUT','300',''),('DEBUG','Oui',''),('SHELL_DIR','/home/asimina/pjt/asimina_engines/prodshop/bin',''),('WITH_MAIL','Oui',''),('MAIL_REPOSITORY','',''),('MAIL_DEBUG','',''),('MAIL_FROM','',''),('MAIL_REPLY','',''),('MAIL_FROM_DISPLAY_NAME','',''),('WKHTMLTOIMAGE_PATH','/home/asimina/pjt/asimina_engines/prodshop/wkhtmltoimage',''),('CALENDAR_DIR','/home/asimina/pjt/asimina_engines/prodshop/calfiles/',''),('CALENDAR_NAME','Dev Calendar',''),('INVOICE_DIR','/home/asimina/tomcat/webapps/asimina_catapulte/upload/invoices/',''),('ANSWERS_URL','/asimina_prodportal/pages/answerquestion.jsp',''),('PDF_REPO','/home/asimina/tomcat/webapps/asimina_prodportal/invoices',''),('HTML_TO_PDF_CMD','/home/asimina/pjt/asimina_engines/prodshop/wkhtmltopdf',''),('SMS_URL','',''),('DEFAULT_SMS_COLUMN','',''),('SMS_URL_PARAMS','',''),('ORANGE_API_MSISDN','',NULL),('SMTP_DEBUG','true',NULL),('VARIANT_IMAGES_URL','https://portail-moringa.com/asimina_prodshop/variant_images/','for emails'),('VARIANT_IMAGE_UPLOAD_DIRECTORY','/home/asimina/tomcat/webapps/asimina_prodshop/variant_images/','for shop'),('CART_URL','/asimina_prodportal/cart/',NULL),('PRODUCTS_IMG_PATH','/asimina_prodcatalog/uploads/products/',NULL),('PRODUCTS_UPLOAD_DIRECTORY','/home/asimina/tomcat/webapps/asimina_prodcatalog/uploads/products/',NULL),('STOCK_ALERT_MAIL_ID','',NULL),('DASHBOARD_PDF_PATH','/home/asimina/tomcat/webapps/asimina_prodshop/custom/dashboard_pdfs/',NULL),('DASHBOARD_EXCEL_PATH','/home/asimina/tomcat/webapps/asimina_prodshop/custom/dashboard_excels/',NULL),('no_admin_bill_download','0','This flag is used in customer edit screen to configure the display of bill download button'),('SAVE_CART_EMAIL_MINS','3',NULL),('ENGINE_NAME','ProdShop',NULL),('use_process_as_order_type','','This flag determines if we have to use order type in shop as process names or fixed as Order. For all asimina shops it must be fixed as Orders so we dont have to change this. This was added for some orange requirement where they wanted process names loaded as order type in mail config screen drop down'),('SHOP_APP_URL','/asimina_prodshop',NULL),('funnel_documents_base_url','/asimina_prodshop/uploads/',NULL),('LOGS_DIRECTORY','/home/asimina/logs/prodshop/',NULL);
...
--
-- Table structure for table `customer_before_order`
--

DROP TABLE IF EXISTS `customer_before_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `customer_before_order` (
  ...
  `batitle` varchar(4) DEFAULT NULL,
  `bafirstname` varchar(32) DEFAULT NULL,
  `balastname` varchar(32) DEFAULT NULL,
  ...
  `bacountry` varchar(32) DEFAULT NULL,
  `datitle` varchar(4) DEFAULT NULL,
  `dafirstname` varchar(32) DEFAULT NULL,
  `dalastname` varchar(32) DEFAULT NULL,
  ...
  `dacountry` varchar(32) DEFAULT NULL,
  ...
  KEY `odate` (`creationDate`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `customer_before_order`
--

LOCK TABLES `customer_before_order` WRITE;
/*!40000 ALTER TABLE `customer_before_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_before_order` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `has_action` VALUES ('OBF','Boutique',4601,'sql:processNow,mail:3,mail:8'),('OBF','DisponibleEnBoutique',4552,'sql:wait7days'),('OBF','LivraisonDomicile',4568,'sql:processNow,mail:1'),('Order','OrderReceived',4575,'mail:7,sql:processNow'),('OBF','CommanceValidee',4576,'sql:stockMinus,sql:shippingType'),('OBF','RelanceDisponible',4554,'mail:7'),('OBF','ColisRemisAuLivreur',4559,'sql:processNow'),('OBF','ColisRemis',4556,'sql:wait2days'),('OBF','CommandeRetractee',4564,'sql:stockPlus'),('OBF','CommandeAnnulee',4565,'sql:wait2days,sql:stockPlus'),('OrangeMoney','ProcessPayment',4606,'ompayment:process'),('OBF','LivraisonStaff',4620,'sql:processNow,mail:11'),('OrangeMoney','NotifyNoWaitBackOffice',4618,'mail:9'),('OrangeMoney','NotifyBackOffice',4615,'mail:8'),('OrangeMoney','ApiError',4612,'sql:wait5minutes'),('OrangeMoney','PaymentError',4609,'sql:wait5minutes'),('OrangeMoney','PaymentSuccess',4611,'sql:processNow'),('OrangeMoney','CheckCustWaitTime',4614,'sql:checkCustWaitTime'),('OBF','EnCoursDePreparationDomicile',4569,'mail:4'),('OBF','ReprogrammationLivraison',4563,'sql:processNow'),('OBF','EnCoursDePreparationStaff',4621,'mail:10'),('Order','InitiatePayment',4624,'sql:waitPayment30mins'),('Forms-9','Formsubmitted',4626,'mail:12,sql:processNow'),('Order-9','InitiatePayment',4627,'sql:waitPayment30mins'),('SSO-9','OrderRecv',4629,'sso:signup');
...
INSERT INTO `page` VALUES ('Orders','/asimina_prodshop/ibo.jsp','',1,0,'cui-home',NULL,NULL),('Supplier','/asimina_prodshop/admin/supplier.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('View Process','/asimina_prodshop/viewProcess.jsp','Processes',2,0,'cui-cursor','cui-graph',NULL),('Orders form field settings','/asimina_prodshop/admin/fieldSettings.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('User management','/asimina_prodshop/admin/userManagement.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('Profile management','/asimina_prodshop/admin/manageProfil.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('Asimina','/asimina_catalog/admin/gestion.jsp','',51,1,'cui-cart',NULL,NULL),('Profils','/asimina_prodshop/admin/profilManagement.jsp','Customers',52,0,'cui-user-follow','cui-people',NULL),('Order Tracking Visible','/asimina_prodshop/admin/orderTrackingVisible.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('Edit Process','/asimina_prodshop/processStatus.jsp','Processes',2,0,'cui-note','cui-graph',NULL),('Dashboard','/asimina_prodshop/dashboard/dashboard.jsp','Analytics',1,0,'cui-speedometer','cui-speedometer','NEW'),('Notifications','/asimina_prodshop/mail_sms/modele.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('Accounts Blocking','/asimina_prodshop/admin/blockedUserConfig.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('Store emails management','/asimina_prodshop/admin/storeEmailsManagement.jsp','Admin',3,0,'cui-wrench','cui-settings',NULL),('Incomplete Carts','/asimina_prodshop/admin/pendingCartsInfo.jsp',NULL,6,0,'cui-cart',NULL,NULL),('Home','/asimina_prodshop/admin/gestion.jsp',NULL,0,0,'cui-home',NULL,''),('Dashboard Filters','/asimina_prodshop/dashboard/dashboardFiltersList.jsp','Analytics',1,0,'cui-speedometer','cui-speedometer','NEW'),('Logs','/asimina_prodshop/admin/logListing.jsp','Admin',4,0,'cui-file',NULL,'BETA'),('Ban rules','/asimina_prodshop/admin/bannedRules.jsp','Admin',10,0,'cui-wrench','cui-settings','NEW');
...
-- Dump completed on 2024-12-05 20:22:02
