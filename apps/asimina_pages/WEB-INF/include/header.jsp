 <header class="c-header c-header-light c-header-fixed c-header-with-subheader" >
			...
			<div class="c-subheader justify-content-between px-3" style="user-select: auto;">
				...
				<div class="c-header-brand d-lg-none" style="user-select: auto;">
					<img src="<%=com.etn.beans.app.GlobalParm.getParm("CATALOG_ROOT")%>/img/logo.png" alt="" style="height: 25px; width: auto; vertical-align: bottom; user-select: auto;">
				...
				<script type="text/javascript">
					$(".c-header-toggler").on("click", function(){
						if(!$($(this).attr("data-target")).hasClass($(this).attr("data-class")))
							$($(this).attr("data-target")).addClass($(this).attr("data-class"));
					});
				</script>
				
				<!-- Breadcrumb-->
				<ol class="breadcrumb border-0 m-0 d-none d-lg-flex" style="user-select: auto;">
					<li class="breadcrumb-item breadcrumb-site" style="user-select: auto;">
						<strong style="user-select: auto;"><%=__selectedsitename%>:</strong></li>
					<%
					...
					%>
					<%--<li class="breadcrumb-item" style="user-select: auto;"><a href="" style="user-select: auto;">Home</a></li>
					<li class="breadcrumb-item" style="user-select: auto;">Xxxxx</li>
					<li class="breadcrumb-item active" aria-current="page" style="user-select: auto;">Name of the page</li>--%>
				</ol>
				<!-- ! Breadcrumb-->
				
				<!-- Favourite-->
				<ul class="c-header-nav ml-auto d-lg-down-none" style="user-select: auto;">
