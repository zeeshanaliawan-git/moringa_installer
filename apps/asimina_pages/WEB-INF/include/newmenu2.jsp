<%
	String version = com.etn.util.AppConfig.getConfig("app_version");
...
<nav class="navbar navbar-dark bg-dark navbar-expand-md fixed-top">
	<div class="container">
			...
			<a class="navbar-brand" href="<%=com.etn.beans.app.GlobalParm.getParm("GESTION_URL")%>">
				<img src="<%=com.etn.beans.app.GlobalParm.getParm("CATALOG_ROOT")%>/img/logo.png" alt="" style="height:20px;width:auto;vertical-align: bottom;">
