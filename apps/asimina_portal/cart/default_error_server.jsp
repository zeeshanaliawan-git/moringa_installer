...
<article class="container-lg TunnelNotice">
    <div class="TunnelNotice-titleContainer">
        ...
        <h3 class="TunnelNotice-title">Votre commande n'a pas pu aboutir. Veuillez renouveler votre paiement</h3>
    </div>
    ...
    <div class="TunnelNotice-bodyContainer">
        ...
        <div class="TunnelNotice-contentContainer">
            <p class="TunnelNotice-textBold">
                Merci de sélectionner un autre mode de paiement. En cas de nouvelle erreur, veuillez contacter notre service client par
            ...
            <a href="javascript:gotoRecap();" class="btn btn-secondary isFullWidthMobile TunnelNotice-button">Revenir au paiement</a>
        </div>
    </div>
</article>
<form name="myform" id='myform' action="payment.jsp" method="post" class="FormValidator PaymentForm row justify-content-between"
