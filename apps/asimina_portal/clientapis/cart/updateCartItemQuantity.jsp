...
<%
	try
	{
		...
		String qty = parseNull(request.getParameter("quantity"));
				...
				if("1".equals(rsSite.value("enable_ecommerce")))
				{
					...
					if(variantId.length() > 0)
					{
						...
						{			
							...
							if(com.etn.asimina.cart.CartHelper.updateItem(Etn,cartId,variantId,updateType,quantity))
							{
							...
							{
								out.write("{\"error\":true,\"status\":" + ErrorTypes.CART_ITEM_NOT_ADDED + ",\"message\":\"" + ErrorMessages.CART_ITEM_NOT_ADDED + "\"}");
							}
						}
					}
					else
