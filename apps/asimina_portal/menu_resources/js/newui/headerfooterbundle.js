...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ts/headerfooterbundleRAW.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var Responsive = /*#__PURE__*/function () {
  ...
  _createClass(Responsive, null, [{
    ...
    value: function init(breakpoints) {
      ...
      Responsive.event(); //console.log('fdsqgfsd');
    }
  }, {
    key: "setBreakpoints",
    ...
    value: function windowHeight() {
      ...
      if (window.navigator.userAgent === "iOS") {
...
/***/ "./src/modules/helper/svg.loader/svg.loader.header.ts":
/*!************************************************************!*\
  !*** ./src/modules/helper/svg.loader/svg.loader.header.ts ***!
  \************************************************************/
/*! exports provided: SvgLoaderHeader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SvgLoaderHeader", function() { return SvgLoaderHeader; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var SvgLoaderHeader = /*#__PURE__*/function () {
  function SvgLoaderHeader() {
    _classCallCheck(this, SvgLoaderHeader);
  }

  _createClass(SvgLoaderHeader, null, [{
    key: "load",
    value: function load() {
      $(function () {
        $('[data-hf-svg]').each(function () {
          var $this = $(this);
          var imgURL = $this.data('hf-svg');

          if (!imgURL) {
            return;
          }

          var $elementsWithSameSource = $('[data-hf-svg="' + imgURL + '"]');
          $elementsWithSameSource.removeAttr('data-hf-svg');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MenuDesktop", function() { return MenuDesktop; });
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
 ...
 // import {Debug} from "../helper/debug/debug";

var MenuDesktop = /*#__PURE__*/function () {
  ...
  _createClass(MenuDesktop, null, [{
    key: "init",
    value: function init() {
      MenuDesktop.$header = $(".etnhf-MenuDesktop").closest("header");
      MenuDesktop.header = MenuDesktop.$header.get(0);
      MenuDesktop.defaultSize = MenuDesktop.$header.attr("data-default-size") || "large";
      MenuDesktop.animateOnScroll = ($("#etn-portal-header").attr("data-animate-on-scroll") || "true") === "true";
      MenuDesktop.doHideTopNav = ($("#etn-portal-header").attr("data-hide-top-nav") || "false") === "true";
      MenuDesktop.menuDesktop = $(".etnhf-MenuDesktop");
      MenuDesktop.menuMobile = $(".etnhf-MenuMobile"); // if(Debug.isNotLoadedTweenMax()){
      //     return;
      // }

      MenuDesktop.$element = $(".etnhf-MenuDesktop");
      MenuDesktop.element = MenuDesktop.$element.get(0);
      MenuDesktop.$menuBrand = $(".etnhf-MenuDesktop-brand");
      MenuDesktop.menuBrand = MenuDesktop.$menuBrand.get(0);
      MenuDesktop.$topNav = $(".etnhf-MenuTop");
      ...
      if (MenuDesktop.$element.length) {
        ...
        if (MenuDesktop.defaultSize === "large") {
          MenuDesktop.showLargeMenu();
        } else if (MenuDesktop.defaultSize === "small") {
          MenuDesktop.showSmallMenu();
        }
      }
    }
  }, {
    ...
    value: function events() {
      // MenuDesktop.$element.find(".etnhf-MenuDesktop-nav-item").on("mouseenter", function () {
      //   const el = $(this).find(".etnhf-collapse");
      //   MenuDesktop.openSubMenu(el);
      // });
      // MenuDesktop.$element.find(".etnhf-MenuDesktop-nav-item").on("mouseleave", function () {
      //   const el = $(this).find(".etnhf-collapse");
      //   MenuDesktop.closeSubMenu(el);
      // });
      MenuDesktop.$element.find(".etnhf-MenuDesktop-nav-item").on("mouseover", function () {
        var el = $(this).find(".etnhf-collapse");
        MenuDesktop.openSubMenu(el);
      });
      MenuDesktop.$element.find(".etnhf-MenuDesktop-nav-item").on("mouseleave", function () {
        var el = $(this).find(".etnhf-collapse");
      ...
      if (MenuDesktop.animateOnScroll) {
        $(window).on("scroll resize orientationchange", function () {
          MenuDesktop.setMenuHeight();
        });
      }

      MenuDesktop.menuDesktop.find(".etnhf-user-connexion-btn").on("click", function () {
        var targetDiv = !$(this).parent().hasClass("etnhf-loggedIn") ? $(".etnhf-ConnexionCart.etnhf-ConnexionCart-offline") : $(".etnhf-ConnexionCart.etnhf-ConnexionCart-connected");

        if ($(this).hasClass("etnhf-open")) {
          //Hides the Offline or Login Div if current button is already active.
          MenuDesktop.menuDesktop.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
          MenuDesktop.menuMobile.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
          $(".etnhf-ConnexionCart.etnhf-ConnexionCart-offline,\n        .etnhf-ConnexionCart.etnhf-ConnexionCart-form,\n        .etnhf-ConnexionCart.etnhf-ConnexionCart-connected").css({
            opacity: 0,
            visibility: "hidden"
          });
          MenuDesktop.menuDesktop.find(".etnhf-user-connexion-triangle").css({
            opacity: 0,
            visibility: "hidden"
          });
          MenuDesktop.menuMobile.find(".etnhf-user-connexion-triangle").css({
            opacity: 0,
            visibility: "hidden"
          });
        } else {
          MenuDesktop.closeNavSearch();
          MenuDesktop.menuDesktop.find(".etnhf-user-connexion-btn").addClass("etnhf-open");
          MenuDesktop.menuMobile.find(".etnhf-user-connexion-btn").addClass("etnhf-open");
          targetDiv.css({
            opacity: 1,
            visibility: "visible"
          });
      ...
      $(".etnhf-ConnexionCart").find(".etnhf-ConnexionCart-close").on("click", function () {
        MenuDesktop.menuDesktop.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
        MenuDesktop.menuMobile.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
        $(".etnhf-ConnexionCart.etnhf-ConnexionCart-offline,\n        .etnhf-ConnexionCart.etnhf-ConnexionCart-form,\n        .etnhf-ConnexionCart.etnhf-ConnexionCart-connected").css({
          opacity: 0,
      ...
      $("body").on("click", function (e) {
        ...
        var searchMenuIsClicked = $clickedElement.closest(".etnhf-ConnexionCart, .etnhf-user-connexion-btn, .etnhf-MenuDesktop-userNav-hello").length;

        if (searchMenuIsClicked === 0) {
          if (MenuDesktop.$element.find(".etnhf-user-connexion-btn, .etnhf-MenuDesktop-userNav-hello").hasClass("etnhf-open")) {
            MenuDesktop.$element.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
            MenuDesktop.$element.find(".etnhf-MenuDesktop-userNav-hello").removeClass("etnhf-open");
            MenuDesktop.$element.find(".etnhf-ConnexionCart-offline").css({
              opacity: 0,
              visibility: "hidden"
            });
            MenuDesktop.$element.find(".etnhf-ConnexionCart-connected").css({
              opacity: 0,
              visibility: "hidden"
            });
            MenuDesktop.$element.find(".etnhf-ConnexionCart-form").css({
              opacity: 0,
              visibility: "hidden"
            });
            MenuDesktop.$element.find(".etnhf-user-connexion-triangle").css({
              opacity: 0,
              visibility: "hidden"
            });
          }
      ...
      MenuDesktop.$element.find(".etnhf-ConnexionCart-offline .etnhf-ConnexionCart-btn > button").on("click", function () {
        MenuDesktop.$element.find(".etnhf-ConnexionCart-offline").css({
          opacity: 0,
          visibility: "hidden"
        });
    ...
    value: function closeNavSearch() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to($(".etnhf-NavSearch"), 0.5, {
        height: 0,
        ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power2"].easeOut
      }); //commented by ABJ. Was creating issues with the react-grid-layout for dynamic pages. 
      //$("body").css({overflow: "auto"});

      gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to($(".etnhf-MainOverlay"), 0.5, {
        backgroundColor: "rgba(51, 51, 51, 0.5)"
      });
      $(".search-btn").removeClass("etnhf-svgMenu");
    }
  }, {
    key: "openSubMenu",
    value: function openSubMenu(elementToExpand) {
      clearTimeout(MenuDesktop.menuOutTimeout);
      MenuDesktop.$element.find(".etnhf-MenuDesktop-nav-panel").css({
        opacity: 0,
        visibility: "hidden"
      });
      elementToExpand.css({
    ...
    value: function closeSubMenu(elementToExpand) {
      ...
      MenuDesktop.menuOutTimeout = setTimeout(function () {
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to($(".etnhf-MenuDesktop-nav-panel"), 0.5, {
          height: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_0__["Power2"].easeOut
        });
        MenuDesktop.collapseIsVisible = false;
    ...
    value: function agrandirMenu() {
      MenuDesktop.$element.removeClass("etnhf-smallH");
      MenuDesktop.$element.addClass("etnhf-largeH");
      $(".WindowFilter").removeClass("etnhf-smallH");
      $(".WindowFilter").addClass("etnhf-largeH");
      window.terminauxListeAppearance = "desktopBig";
      window.headerMenuAppearance = "largeH";
      MenuDesktop.menuAppearance = "largeH";
    }
  }, {
    key: "retrecirMenu",
    value: function retrecirMenu() {
      MenuDesktop.$element.removeClass("etnhf-largeH");
      MenuDesktop.$element.addClass("etnhf-smallH");
      $(".WindowFilter").removeClass("etnhf-largeH");
      $(".WindowFilter").addClass("etnhf-smallH");
      window.terminauxListeAppearance = "desktopSmall";
      window.headerMenuAppearance = "smallH";
      ...
      if (MenuDesktop.$topNav.height() === 0) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].from(MenuDesktop.$topNav, 0.5, {
          ...
          onComplete: function onComplete() {
            window.dispatchEvent(new CustomEvent("moringa.menuresized"));
          }
        });
      }
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MenuMobile", function() { return MenuMobile; });
...
var MenuMobile = /*#__PURE__*/function () {
  ...
  _createClass(MenuMobile, null, [{
    key: "init",
    value: function init() {
      MenuMobile.menuDesktop = $(".etnhf-MenuDesktop");
      MenuMobile.menuMobile = $(".etnhf-MenuMobile");
      MenuMobile.$element = $(".etnhf-MenuMobile");
      MenuMobile.element = MenuMobile.$element.get(0);

      if (MenuMobile.$element.length) {
        MenuMobile.getMenuMaxHeight();
        ...
        window.menuMobileClosedOnce = false;

        if (window.innerWidth < 980) {
          MenuMobile.openSubMenu();
          MenuMobile.closeSubMenu();
          window.menuMobileClosedOnce = true;
        }

        $(window).resize(function () {
          if (window.innerWidth < 980 && !window.menuMobileClosedOnce) {
            MenuMobile.openSubMenu();
            MenuMobile.closeSubMenu();
            window.menuMobileClosedOnce = true;
          }
    ...
    key: "events",
    value: function events() {
      MenuMobile.$element.find(".etnhf-burgerIcon").on("click", function () {
        if ($(this).hasClass("etnhf-open")) {
          $(this).removeClass("etnhf-open");
          MenuMobile.closeSubMenu();
        } else {
          $(this).addClass("etnhf-open");
          MenuMobile.openSubMenu();
        }
      });
      MenuMobile.$element.find(".etnhf-MenuMobile-nav-link").on("click", function () {
        var el = $(this).siblings(".etnhf-collapse");
        MenuMobile.goToSecondSlide(el);
      });
      MenuMobile.$element.find(".etnhf-MenuMobile-subHeader").on("click", function () {
        MenuMobile.goToFirstSlide();
      });
      MenuMobile.$element.find(".etnhf-MenuMobile-subItem-link").on("click", function () {
        var el = $(this).siblings(".etnhf-MenuMobile-subSubNavWrapper");
        MenuMobile.goToThirdSlide(el);
      });
      MenuMobile.$element.find(".etnhf-MenuMobile-subSubBack").on("click", function () {
        MenuMobile.backToSecondSlide();
      });
      MenuMobile.$element.find(".etnhf-user-connexion-btn").on("click", function () {
        var targetDiv = !$(this).parent().hasClass("etnhf-loggedIn") ? $(".etnhf-ConnexionCart.etnhf-ConnexionCart-offline") : $(".etnhf-ConnexionCart.etnhf-ConnexionCart-connected");

        if ($(this).hasClass("etnhf-open")) {
          MenuMobile.menuDesktop.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
          MenuMobile.menuMobile.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
          $(".etnhf-ConnexionCart-offline").css({
            opacity: 0,
            visibility: "hidden"
          });
          $(".etnhf-ConnexionCart-form").css({
            opacity: 0,
            visibility: "hidden"
          });
          $(".etnhf-ConnexionCart-connected").css({
            opacity: 0,
            visibility: "hidden"
          });
          MenuMobile.menuDesktop.find(".etnhf-user-connexion-triangle").css({
            opacity: 0,
            visibility: "hidden"
          });
          MenuMobile.menuMobile.find(".etnhf-user-connexion-triangle").css({
            opacity: 0,
            visibility: "hidden"
          });
        } else {
          // MenuMobile.closeNavSearch();
          MenuMobile.menuDesktop.find(".etnhf-user-connexion-btn").addClass("etnhf-open");
          MenuMobile.menuMobile.find(".etnhf-user-connexion-btn").addClass("etnhf-open");
          targetDiv.css({
            opacity: 1,
            visibility: "visible"
          });
      ...
      $(".etnhf-ConnexionCart").find(".etnhf-ConnexionCart-close").on("click", function () {
        MenuMobile.$element.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
        $(".etnhf-ConnexionCart").css({
          opacity: 0,
          visibility: "hidden"
        });
        MenuMobile.$element.find(".etnhf-user-connexion-triangle").css({
          opacity: 0,
          visibility: "hidden"
        });
      });
      $("body").on("click", function (e) {
        var $clickedElement = $(e.target);
        var searchMenuIsClicked = $clickedElement.closest(".etnhf-ConnexionCart, .etnhf-user-connexion-btn").length;

        if (searchMenuIsClicked === 0) {
          if (MenuMobile.$element.find(".etnhf-user-connexion-btn").hasClass("etnhf-open")) {
            MenuMobile.$element.find(".etnhf-user-connexion-btn").removeClass("etnhf-open");
            $(".etnhf-ConnexionCart-offline").css({
              opacity: 0,
              visibility: "hidden"
      ...
      $(".etnhf-ConnexionCart").find(".etnhf-ConnexionCart-offline .etnhf-ConnexionCart-btn > button").on("click", function () {
        $(".etnhf-ConnexionCart-offline").css({
          opacity: 0,
          visibility: "hidden"
        });
    ...
    value: function getMenuMaxHeight() {
      return _helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_0__["Responsive"].windowHeight() - MenuMobile.$element.height();
    } // public static calculateCollapseMaxHeight() {
    //   const MenuMobileCollapseHeight = $(".etnhf-MenuMobile-collapse").height();
    ...
    value: function openSubMenu() {
      TweenMax.to(MenuMobile.$element.find(".etnhf-MenuMobile-wrapper"), 0.5, {
        y: "0%",
        visibility: 'visible',
        className: '+=isScrollable'
      });
      MenuMobile.$element.find(".etnhf-burgerIcon").addClass("etnhf-open");
      $('html, body').addClass('etnhf-modal-open');
      $('.etnhf-MainOverlay').css({
        visibility: 'visible',
        backgroundColor: 'rgba(51, 51, 51, 0.5)'
      });
    }
    ...
    value: function closeSubMenu() {
      ...
      MenuMobile.goToFirstSlide();
      MenuMobile.$element.find(".etnhf-burgerIcon").removeClass("etnhf-open");
      $('html, body').removeClass('etnhf-modal-open');
      $('.etnhf-MainOverlay').css({
        visibility: 'hidden',
        backgroundColor: 'rgba(51, 51, 51, 0.5)'
      });
    ...
    value: function goToSecondSlide(elementToShow) {
      $(".etnhf-MenuMobile-nav-panel").css({
        opacity: "0",
        visibility: "hidden"
      });
      elementToShow.css({
      ...
      $('.etnhf-MenuMobile-wrapper').height(height);

      if ($("html").attr("dir") === "rtl") {
        TweenMax.to(MenuMobile.$element.find(".etnhf-MenuMobile-collapse"), 0.5, {
          x: "100%"
        });
      } else {
        TweenMax.to(MenuMobile.$element.find(".etnhf-MenuMobile-collapse"), 0.5, {
    ...
    value: function goToFirstSlide() {
      MenuMobile.addScroll(MenuMobile.$element.find(".etnhf-MenuMobile-collapse"));
      TweenMax.to(MenuMobile.$element.find(".etnhf-MenuMobile-collapse"), 0.5, {
        x: "0%"
      });
    }
    ...
    value: function goToThirdSlide(elementToShow) {
      $(".etnhf-MenuMobile-subSubNavWrapper").css({
        opacity: "0",
        visibility: "hidden"
      });
      MenuMobile.addScroll(elementToShow);
    ...
    value: function addScroll($elementToShow) {
      var height = $elementToShow.height();
      var $menuMobileWrapper = $('.etnhf-MenuMobile-wrapper');
      var maxHeight = MenuMobile.getMenuMaxHeight();
      $menuMobileWrapper.height(height);

      if (height > maxHeight) {
        $menuMobileWrapper.height("").addClass('etnhf-isScrollable');
      } else {
        $menuMobileWrapper.height(height).removeClass('etnhf-isScrollable');
      }
    }
  }]);
...
/*!***************************************************!*\
  !*** ./src/modules/ui/home-footer/home-footer.ts ***!
  \***************************************************/
/*! exports provided: HomeFooter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeFooter", function() { return HomeFooter; });
/* harmony import */ var modules_helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! modules/helper/responsive/responsive */ "./src/modules/helper/responsive/responsive.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var HomeFooter = /*#__PURE__*/function () {
  function HomeFooter() {
  ...
  _createClass(HomeFooter, null, [{
    key: "init",
    value: function init() {
      HomeFooter.$element = $(".etnhf-HomeFooter");
    ...
    key: "events",
    value: function events() {
      HomeFooter.$element.find(".etnhf-HomeFooter-navSection").each(function () {
        if (!$(this).next('ul.etnhf-HomeFooter-dropdown').is(':empty')) {
          //IF UL next to it is not empty, assign click event to it
          $(this).on("click", function (e) {
            if (!modules_helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_0__["Responsive"].isMin("minLg")) {
              var $el = $(this);

              if ($el.hasClass("etnhf-isOpen")) {
                $el.removeClass("etnhf-isOpen");
                HomeFooter.closeDropdown($el.closest("li").find(".etnhf-HomeFooter-dropdown"));
              } else {
                $el.addClass("etnhf-isOpen");
                HomeFooter.openDropdown($el.closest("li").find(".etnhf-HomeFooter-dropdown"));
              }
            }
          });
        } else {
    ...
    value: function openDropdown($el) {
      ...
      var $arrow = $el.parent().find(".etnhf-HomeFooter-navSection svg");
...
/***/ "./src/modules/ui/home-mobile-help/home-mobile-help.ts":
/*!*************************************************************!*\
  !*** ./src/modules/ui/home-mobile-help/home-mobile-help.ts ***!
  \*************************************************************/
/*! exports provided: HomeMobileHelp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeMobileHelp", function() { return HomeMobileHelp; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var HomeMobileHelp = /*#__PURE__*/function () {
  function HomeMobileHelp() {
    _classCallCheck(this, HomeMobileHelp);
  }

  _createClass(HomeMobileHelp, null, [{
    key: "init",
    value: function init() {
      HomeMobileHelp.$element = $(".etnhf-HomeMobileHelp");
      HomeMobileHelp.element = HomeMobileHelp.$element.get(0);
      HomeMobileHelp.lastScrollTop = 0;
      HomeMobileHelp.scrollingBottom = false;
      HomeMobileHelp.scrollingTop = false;

      if (HomeMobileHelp.$element.length) {
        HomeMobileHelp.events();
      }
    }
  }, {
    key: "events",
    value: function events() {
      $(window).on("scroll", function () {
        ...
        if (st > HomeMobileHelp.lastScrollTop) {
          HomeMobileHelp.scrollingBottom = true;
        } else {
          HomeMobileHelp.scrollingTop = true;
        }

        HomeMobileHelp.lastScrollTop = st;
      });
      setInterval(function () {
        if (HomeMobileHelp.scrollingBottom === true) {
          HomeMobileHelp.scrollingBottom = false;
          HomeMobileHelp.hideComponent();
        }

        if (HomeMobileHelp.scrollingTop === true) {
          HomeMobileHelp.scrollingTop = false;
          HomeMobileHelp.showComponent();
        }
      }, 250);
    }
  }, {
    ...
    value: function showComponent() {
      if (TweenMax.isTweening(HomeMobileHelp.$element) === false) {
        if (HomeMobileHelp.$element.offset().top + 100 < $(document).height()) {
          TweenMax.to(HomeMobileHelp.$element, 0.5, {
            bottom: 0,
            ease: Power2.easeOut
          });
        }
  ...
  return HomeMobileHelp;
}();

_defineProperty(HomeMobileHelp, "element", void 0);

_defineProperty(HomeMobileHelp, "$element", void 0);

_defineProperty(HomeMobileHelp, "lastScrollTop", void 0);

_defineProperty(HomeMobileHelp, "scrollingBottom", void 0);

_defineProperty(HomeMobileHelp, "scrollingTop", void 0);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NavSearch", function() { return NavSearch; });
/* harmony import */ var _helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../helper/responsive/responsive */ "./src/modules/helper/responsive/responsive.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var NavSearch = /*#__PURE__*/function () {
  ...
  _createClass(NavSearch, null, [{
    key: "init",
    value: function init() {
      NavSearch.$element = $(".etnhf-NavSearch");
    ...
    key: "events",
    value: function events() {
      $(".etnhf-search-btn").on("click", function () {
      ...
      $("body").on("click", function (e) {
        var $clickedElement = $(e.target);
        var searchMenuIsClicked = $clickedElement.closest(".etnhf-NavSearch, .etnhf-search-btn").length;
    ...
    value: function openNavSearch() {
      ...
      TweenMax.to($(".etnhf-MainOverlay"), 0.5, {
        backgroundColor: "rgba(0, 0, 0, 0.75)"
      });
      $(".etnhf-search-btn").addClass("etnhf-svgMenu");
      $(".etnhf-NavSearch input.etnhf-SearchForm-input").trigger("focus");
    }
  }, {
    key: "closeNavSearch",
    value: function closeNavSearch() {
      ...
      $(".etnhf-search-btn").removeClass("etnhf-svgMenu");
    }
  }, {
    key: "setMaxHeight",
...
/***/ "./src/ts/headerfooterbundleRAW.ts":
/*!*****************************************!*\
  !*** ./src/ts/headerfooterbundleRAW.ts ***!
  \*****************************************/
/*! no exports provided */
...
/* harmony import */ var _modules_menu_desktop_menu_desktop__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/menu-desktop/menu-desktop */ "./src/modules/menu-desktop/menu-desktop.ts");
/* harmony import */ var _modules_menu_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/menu-mobile/menu-mobile */ "./src/modules/menu-mobile/menu-mobile.ts");
/* harmony import */ var _modules_helper_svg_loader_svg_loader_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/helper/svg.loader/svg.loader.header */ "./src/modules/helper/svg.loader/svg.loader.header.ts");
/* harmony import */ var _modules_ui_nav_search_nav_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../modules/ui/nav-search/nav-search */ "./src/modules/ui/nav-search/nav-search.ts");
/* harmony import */ var _modules_ui_home_footer_home_footer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/ui/home-footer/home-footer */ "./src/modules/ui/home-footer/home-footer.ts");
/* harmony import */ var _modules_ui_home_mobile_help_home_mobile_help__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../modules/ui/home-mobile-help/home-mobile-help */ "./src/modules/ui/home-mobile-help/home-mobile-help.ts");
...
function initAll() {
  _modules_menu_desktop_menu_desktop__WEBPACK_IMPORTED_MODULE_1__["MenuDesktop"].init();
  _modules_menu_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_2__["MenuMobile"].init();
  _modules_helper_svg_loader_svg_loader_header__WEBPACK_IMPORTED_MODULE_3__["SvgLoaderHeader"].load();
  _modules_ui_nav_search_nav_search__WEBPACK_IMPORTED_MODULE_4__["NavSearch"].init();
  _modules_ui_home_footer_home_footer__WEBPACK_IMPORTED_MODULE_5__["HomeFooter"].init();
  _modules_ui_home_mobile_help_home_mobile_help__WEBPACK_IMPORTED_MODULE_6__["HomeMobileHelp"].init();
  $("#etn-portal-header").on('click', ".etnhf-ConnexionCart.etnhf-ConnexionCart-offline .etnhf-ConnexionCart-btn button", function () {
    $(".etnhf-ConnexionCart.etnhf-ConnexionCart-offline").css({
      opacity: 0,
      visibility: "hidden"
    });
    $(".etnhf-ConnexionCart.etnhf-ConnexionCart-form").css({
      opacity: 1,
      visibility: "visible"
    });
  });
  $('.etnhf-MenuDesktop-brand-small').removeAttr('style'); // Boosted Arrow Collapse Animation

  var $collapse = $(".etnhf-collapse");

  if ($collapse.length > 0) {
    $collapse.on("show.bs.collapse", function () {
      var $arrow = $(this).siblings("button").find("img, svg");
      gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to($arrow, 0.2, {
        rotation: 180
      });
    });
...
document.addEventListener("moringa.loadmenu", function (event) {
  initAll();
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
...
___portaljquery(window).bind('load', function() 
{
	...
	{
		if(___portaljquery(this).attr('id') != '___portalhomepagelink' && ___portaljquery(this).attr('href') != "#" && ___portaljquery(this).hasClass('___portalmenulink') == false )
		{
...
___portaljquery(document).ready(function() {
	...
	___doUrlSearch=function(sval)
	{
		if(___portaljquery.trim(sval) != '')
		{
			if(____searchurl != "")
			{
				if(____searchparam != "")
				{
					if(____searchurl.indexOf("?") > -1) window.location = ____searchurl + "&" + ____searchparam + "=" + ___portaljquery.trim(sval);
					else window.location = ____searchurl + "?" + ____searchparam + "=" + ___portaljquery.trim(sval);
				}
				else window.location = ____searchurl;
			}			
		}
	};

	___portaljquery(".urlmoringaheadersearchfield").on("keyup", function(e)
	{
		var unicode = e.charCode ? e.charCode : e.keyCode;
		e.preventDefault();
		if(unicode == 13)
		{
			___doUrlSearch(___portaljquery(this).val());
		}
		return false;
	});

	___portaljquery("#urldesktopsearchbtn").on("click touch", function(e)
	{
		e.preventDefault();
		___doUrlSearch(___portaljquery("#moringadesktopsearchfield").val());
		return false;
	});

	___portaljquery("#urlmobilesearchbtn").on("click touch", function(e)
	{
		e.preventDefault();
		___doUrlSearch(___portaljquery("#moringamobilesearchfield").val());
		return false;
	});
	...
	___portaljquery("#internaldesktopsearchbtn").on("click touch", function()
	{
		___doInternalSearch(___portaljquery("#moringadesktopsearchfield").val());
	});

	___portaljquery("#internalmobilesearchbtn").on("click touch", function()
	{
	...
	__checkLogin=function()
	{
		...
		___portaljquery.ajax({
			...
			success : function(resp)
			{
				...
				{
					___portaljquery(".___portal_login_container").removeClass("etnhf-loggedIn");
					___portaljquery("#___logintoken").val(resp.token);
				}
				else if(resp.su == "1" || resp.login == "1")
				{
					__showMenus();
					___portaljquery(".___portal_login_container").addClass("etnhf-loggedIn");
					___portaljquery("#___lcname").html(resp.cname);

					if(resp.avatar && resp.avatar != '') 
					{						
						___portaljquery("#_mrng_avatar").html('<img style="border-radius:50% !important" src="'+resp.avatar+'" alt="avatar" >');
					}

					if(typeof dataLayer !== 'undefined' && dataLayer != null) 
					{
						_etn_dl_obj.orange_client_id = resp.cuid;
				...
				if(resp.homepage)
				{
					___portaljquery("#___portalhomepagelink").attr("href",resp.homepage);
				}
			},
			error : function()
			{
		...
		___portaljquery.ajax({
			...
			success : function(json)
			{
				if(json.response == 'error') 
				{
					...
					{
						$("#_loginalertdiv").html(json.message);
						$("#_loginalertdiv").fadeIn();
						if(json._gotoUrl)
						{
							window.location.href = json._gotoUrl;
						}
					}
				}
				else if(json.response == 'success')
				{
					...
					{
						var __scookiesecure = 'sameSite=strict'; 
						if(location.protocol === 'https:') __scookiesecure += ';secure';
						
						var now = new Date();
						now.setTime( now.getTime() + 7 * 24 * 3600 * 1000 ); //7 days expiry
						if(json.cuid) document.cookie = "_rme_cuid="+json.cuid+";"+__scookiesecure+"; expires="+now.toUTCString()+"; path="+______portalurl2;
						if(json.token) document.cookie = "_rme_token="+json.token+";"+__scookiesecure+"; expires="+now.toUTCString()+"; path="+______portalurl2;
						if(json.validator) document.cookie = "_rme_vld="+json.validator+";"+__scookiesecure+"; expires="+now.toUTCString()+"; path="+______portalurl2;
					}
		...
		___portaljquery.ajax({
			...
			success : function(json)
			{
				if(json.response == "success")
				{
					...
					document.cookie = "_rme_cuid=;"+__scookiesecure+"; expires=Thu, 01 Jan 1970 00:00:01 GMT; path="+______portalurl2;
					document.cookie = "_rme_token=;"+__scookiesecure+"; expires=Thu, 01 Jan 1970 00:00:01 GMT; path="+______portalurl2;
					document.cookie = "_rme_vld=;"+__scookiesecure+"; expires=Thu, 01 Jan 1970 00:00:01 GMT; path="+______portalurl2;
				}
				__gotoPortalHome();
			},
			error : function()
	...
	__showMenus=function()
	{
		...
		___portaljquery(".logged_in_user").each(function(){
			___portaljquery(this).removeClass('etnhf-d-none');
		});
	};
	...
	___pushDataLayerProductImpression=function(that, typ)
	{
		...
		if(typeof dataLayer !== 'undefined' && dataLayer != null)
		{
			var productImpression = new Object();
						...
						if(typ=='load'){
							ecommerceObj.load = {actionField:{'list':'Search results'}};
						}
						else {
