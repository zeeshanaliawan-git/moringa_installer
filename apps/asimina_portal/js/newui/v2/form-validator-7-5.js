/*! Orange MEA 7.5.0 - new/1 - form-validator - 2022-07-12T15:19:17.498Z */
...
var FormValidator = /*#__PURE__*/function () {
  function FormValidator(element) {
    ...
    _defineProperty(this, "debug", new _helper_debug_debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .c(true));
    ...
    value: function onNext() {
      ...
      this.$element.on("click", '.JS-FormValidator-submit', function (event) {
        ...
        if (!_this2.validity) {
          ...
          _this2.$element.trigger('FormValidator:submit');
