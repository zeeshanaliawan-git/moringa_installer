...
//	_url = getUrl(_url);
	...
	_url = ______portalurl + 'process.jsp?___mid='+______mid+'&___isajax=1&___noscript=1&___mainurl='+______durl+'&___goto='+Base64.encode(_url);
...
//	_url = getUrl(_url);
	...
	_url = ______portalurl + 'process.jsp?___mid='+______mid+'&___mainurl='+______durl+'&___goto='+Base64.encode(_url);
	return _url;
}
...
function getUrl(_url) 
{
	...
	if(_url.startsWith("http://" + ourhost) || _url.startsWith("https://" + ourhost) ) 
	{
