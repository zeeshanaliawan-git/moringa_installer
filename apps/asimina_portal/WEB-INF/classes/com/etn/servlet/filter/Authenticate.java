...
public class Authenticate implements Filter
{
    ...
    public void doFilter(ServletRequest _request, ServletResponse _response, FilterChain chain) throws IOException, ServletException
    {
		...
		com.etn.util.Logger.info("Portal doFilter","serverName::"+serverName);
...
//						System.out.println("Returned json " + jsonresponse);
			...
			else
			{
				...
				String __n = null;
				String __p = null;
				String __auth = parseNull(request.getHeader("Authorization"));
        ...
        {        
			...
			if(rs.next())
			{
				if("TEST_SITE_ACCESS".equalsIgnoreCase(rs.value("profil"))) ok = true;
			}
			if(!ok)
			{
				System.out.println("Test-site-access by invalid profil");
				Etn.close();
			}
		}	
