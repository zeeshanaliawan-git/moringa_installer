...
%><%
	...
	//String sep = ";"; 
	out.write("\"Order Ref\";\"Order Date\";\"Status change date\";\"Name\";\"Status\";\"Message\";\"Process\";\"Payment mode\";\"Delivery fee\";\"Delivery mode\";\"Delivery by\";\"Delivery city\";\"Address line 1\";\"Telephone\";\"Email\";\"Total paid\";\"SKU\";\"Product name\";\"Quantity\";\"Price before discount\";\"Price after discount\"");
	while(rs.next())
	{	
			...
			out.write(";\""+orderSnapshot.getString("paymentDisplayName")+"\"");
            out.write(";\""+parseNull(rs.value("delivery_fees"))+"\"");
            ...
            out.write(";\""+parseNull(rs.value("datowncity"))+"\"");
