...
<% 
  ...
  {
     String cmd = "/home/ronaldo/pjt/dev_engines/shop/testMail "+request.getParameter("mailid").replace("../","")+" "+request.getParameter("sendTo").replace("../","")+
      " "+request.getParameter("ordertyp").replace("../","") ;
            ...
            <div class="card-body">
              ...
              <h3>Attachments to existing emails</h3>
                <table class="table table-responsive-sm resultat table-hover table-striped" style="table-layout:fixed">
                    ...
                    <tbody>
                        <%
                        Set rsM = Etn.execute("select * from mails where site_id="+escape.cote(siteId)+" order by id");
                        while(rsM.next())
                        { %>
                ...
                <table class="table table-responsive-sm resultat table-hover table-striped" style="table-layout:fixed">
                    ...
                    <tbody>
                        <%
                        rsM = Etn.execute("select * from mails where site_id="+escape.cote(siteId)+" order by id");
                        while(rsM.next())
                        {
                        ...
                        <tr id="c<%=rsM.value("id")%>">
                            ...
                            <% } %>
                        <tr>
                            <td colspan="<%=colspan%>"><input class="form-control"type="text" id="suj" value="" placeholder='Mail subject'
					...
					<!-- for the time being we disable this functionality -->
