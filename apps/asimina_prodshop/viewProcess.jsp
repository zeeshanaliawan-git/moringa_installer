...
<%
	...
	if(((String)session.getAttribute("PROFIL")).equals("ADMIN")) partialUpdate = true;
...
<!-- <link rel="stylesheet" type="text/css" href="css/delivery_mt.css"> -->
...
<div class="c-wrapper c-fixed-components">
    ...
    <div class="c-body">
		...
		<!-- toolbar starts -->
		<div id="toolbar" style="position: absolute;display:none; width:120px;right:520px;z-index: 1000;" class="pull-right">
		...
		<div style="position:absolute; z-index:10000; display:none; text-align:left; right: 355px;width:165px;" id="profToolbar" class="pull-right">
			<% while(allProfs.next()) { %>
		...
		<div style="position: absolute; z-index:10000; display:none; text-align:left;right:355px;width:165px;" id="phaseToolbar" class="pull-right">
	...
	<form id="filter" name="filter" method="POST" action="viewProcess.jsp" style="flex-shrink: 0;">
		<div style="padding:15px;">
			...
			<div class="" style="margin-bottom:15px;">
				...
				<div id="legend" style="margin-top: 20px;display: block;">
	...
	<div id="divGraph" style="border-top:1px solid gray;width:3000;height: 3000px;position: relative;;overflow-x: auto;flex-grow: 1;background-color:white">
	</div>
</div>
                </main>
...
<jsp:include page="loadGraphicalProcess.jsp" >  
	<jsp:param name="process" value="<%=UIHelper.escapeCoteValue(proc)%>" />  
