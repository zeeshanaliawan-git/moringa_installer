...
%>
<%!void init_variable(javax.servlet.http.HttpServletRequest req,com.etn.beans.Contexte Etn){
...
%>
<%!String details_variables_f(String filtres,String liste){
	String r = "";
...
%><%!String manqueVariable(javax.servlet.http.HttpServletRequest req,java.util.HashMap<String,String> h){
...
<%!String verif_variable(javax.servlet.http.HttpServletRequest req,com.etn.beans.Contexte Etn){
	javax.servlet.http.HttpSession session =  req.getSession(true);
	...
	if(! str_var.equals("")){
			...
			String sql_var2 = "select concat(`variables`,' --> ',requete_name) from  requete where  (person_id = "+Etn.getId()+" or partage = 1) and `variables`<>''";
        ...
        String que= "Select home_page from person where person_id='"+pId+"';";
        ...
        if(rset.next()){
            ...
            if(url==null || url.equals("") || url.equals(" ")){
				String que2="select home_page from profilperson JOIN profil ON profilperson.profil_id = profil.profil_id where person_id='"+pId+"';";
...
<%!String details_variables_v(String valeurs,String liste,int type){
	String r = "";
...
%>
<%!String descVariable(String liste,String var){
	String r = "";
	int f=-1;
	if(! liste.equals("")){
...
<%!String descVariable2(String liste,String var){
	String r = "";
	int f=-1;
	if(! liste.equals("")){
	f = RetourneIndex_v(liste.split(";"),var);
...
<%!String getVariable(javax.servlet.http.HttpServletRequest req,String filtre,String valeur){ 
	javax.servlet.http.HttpSession session =  req.getSession(true);
	String r = "";
...
<%//liste les filtres %>
<%!String liste_filtre_variable(String liste,javax.servlet.http.HttpServletRequest req){ 
	String l = "";
	javax.servlet.http.HttpSession session =  req.getSession(true);
...
<%//liste les valeurs %>
<%!String liste_valeur_variable(String liste,javax.servlet.http.HttpServletRequest req){ 
	String l = "";
	javax.servlet.http.HttpSession session =  req.getSession(true);
