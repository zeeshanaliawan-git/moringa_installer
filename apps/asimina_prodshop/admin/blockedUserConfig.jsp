                       ...
                       <div class="col pl-5 pt-3">
                           <form action="blockedUserConfig.jsp" method="post">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-3">
                                       <div class="input-group w-75">
                                           <input type="text" name="userBlockTime" value="<%=escapeHtml(userBlockTime)%>" onkeyup="allowNumberOnly(this)" class="form-control text-center"  required >
                                   ...
                                   <div class="col-3">
                                       <input type="text" class="form-control w-25 text-center" name="userTries" value="<%=escapeHtml(userTries)%>" onkeyup="allowNumberOnly(this)" required >
                                   </div>
                               </div>
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-3" >
                                       <div class="input-group w-75">
                                           <input type="text" name="ipBlockTime" value="<%=escapeHtml(ipBlockTime)%>" onkeyup="allowNumberOnly(this)" class="form-control text-center" required >
                                   ...
                                   <div class="col-3">
                                       <input type="text" class="form-control w-25 text-center" name="ipTries" value="<%=escapeHtml(ipTries)%>" onkeyup="allowNumberOnly(this)"  required >
                                   </div>
                               </div>
