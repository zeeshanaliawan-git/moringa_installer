...
//we need a global variable if we want to do validations in custom js added to form then we need this flag to stop form from submit
...
function register_demand(ele){
	...
	if(formIsValid && !flag && !telephoneFlag && !radioFlag && !checkboxFlag && !selectFlag && !reCaptchaFlag){
