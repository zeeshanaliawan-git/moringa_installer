  ...
  $('#demand_form').find("input[type=number]").each(function(){
	...
	$("#form_template_form_name").on("keyup", function(){
	  ...
	  $(".tel").each(function(i){
		...
		let _autoFormatTelNo = false;
		if($(this).attr("auto-format-tel-no") && $(this).attr("auto-format-tel-no") == "true")
		{
			_autoFormatTelNo = true;
		}
	    ...
	    var iti = window.intlTelInput(this, {
		  ...
		  formatAsYouType: _autoFormatTelNo,
		  formatOnDisplay: _autoFormatTelNo
