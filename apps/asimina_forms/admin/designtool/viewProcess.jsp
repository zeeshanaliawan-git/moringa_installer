...
<%	
	...
	String processesQry = "select distinct process from phases where process in (select table_name from process_forms_unpublished where site_id = "+escape.cote(siteid)+") order by process ";
...
<title>Processes</title>
    ...
    <body class="light-blue position-relative">
        <%@include file="/WEB-INF/include/menu2.jsp"%>
        <!-- toolbar starts -->
        <div class="container">
