...
public class UIHelper {
    ...
    public static String getLangInputs(List<Language> langslist, String id, String name, String colName,
            Set rs) {
    ...
    public static String getLangCheckBoxRowWise(List<Language> langslist, String id, String name,
    ...
    public static String getLangTextAreas(List<Language> langslist, String rows, String id, String name,
    ...
    public static String getLangTextAreasRowWise(List<Language> langslist, String id, String name,
            String colName, Set rs) {
