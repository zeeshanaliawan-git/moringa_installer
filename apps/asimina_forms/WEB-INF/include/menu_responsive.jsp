...
<%
    ...
    {
        __rs = Etn.execute("select p.* from page p, page_profil pp where pp.url = p.url and pp.profil_id = " + escape.cote((String)request.getSession().getAttribute("PROFIL_ID")) + " order by p.rang");//change
    }
    while(__rs.next())
    {
