...
%>
		...
		<div class="c-sidebar-brand-full" style="user-select: auto;">
			<img src="<%=com.etn.beans.app.GlobalParm.getParm("FORMS_WEB_APP")%>img/logo.png" alt="" style="height: 25px; width: auto; vertical-align: bottom; user-select: auto;">
		...
		<img class='c-sidebar-brand-minimized' src="<%=com.etn.beans.app.GlobalParm.getParm("FORMS_WEB_APP")%>img/logo.png" alt="" style="height:20px;width:auto;vertical-align: bottom;">
	</div>
	...
	function addToShortcut(pageName){
		$.ajax({
			url: '<%=request.getContextPath()%>/admin/keepSessionAlive.jsp', type: 'POST', dataType: 'json',
			data: {
