...
<tr>
<td style="vertical-align: top;padding-top: 20px;"><a href="<%=com.etn.beans.app.GlobalParm.getParm("GESTION_URL")%>" style='color:green;font-weight:bold;font-size: 13pt;text-decoration: none;'><%=com.etn.beans.app.GlobalParm.getParm("APP_NAME")%></a></td>
...
<script id="__script__faqs__include__" src="<%=com.etn.beans.app.GlobalParm.getParm("FAQS_EXTERNAL_PATH")%>"></script>	
