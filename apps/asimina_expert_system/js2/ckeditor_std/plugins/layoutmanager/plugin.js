...
LayoutManager.prototype.changeLayoutAction = function (newLayoutName) {
  ...
  if (newColumnsCount <= columnsCount) {
    ...
    for (var i = columnsCount; i < newColumnsCount; i++) {
      ...
      insertedCol.addClass('layout-column-editable');
...
function LayoutBuilder() {
  ...
  defaultLayoutTemplates.push(new CKEDITOR.template('<div class="layoutmanager">'+
            '<div class="row layout-container layout-row" >'+
                '<div class="col-xs-{size1} col-sm-{size1} col-md-{size1} col-lg-{size1} layout-column layout-column-one layout-column-editable">'+
                    '<p></p>'+
                '</div>'+
            '</div>'+
        '</div>'));
  defaultLayoutTemplates.push(new CKEDITOR.template('<div class="layoutmanager">'+
            '<div class="row layout-container layout-row">'+
                '<div class="col-xs-{size1} col-sm-{size1} col-md-{size1} col-lg-{size1} layout-column layout-column-one layout-column-editable">'+
                    '<p></p>'+
                '</div>'+
                '<div class="col-xs-{size2} col-sm-{size2} col-md-{size2} col-lg-{size2} layout-column layout-column-two layout-column-editable">'+
                    '<p></p>'+
                '</div>'+
            '</div>'+
        '</div>'));
  defaultLayoutTemplates.push(new CKEDITOR.template('<div class="layoutmanager">'+
            '<div class="row layout-container layout-row">'+
                ...
                '<div class="col-xs-{size2} col-sm-{size2} col-md-{size2} col-lg-{size2} layout-column layout-column-two layout-column-editable">'+
                    '<p></p>'+
                '</div>'+
                '<div class="col-xs-{size3} col-sm-{size3} col-md-{size3} col-lg-{size3} layout-column layout-column-three layout-column-editable">'+
                    '<p></p>'+
                '</div>'+
            '</div>'+
        '</div>'));
