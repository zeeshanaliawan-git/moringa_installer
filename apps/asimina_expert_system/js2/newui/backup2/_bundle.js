...
/******/ 		return __webpack_require__.p + "" + ({"category-filter":"category-filter","essentiel":"essentiel","flash-counter":"flash-counter"}[chunkId]||chunkId) + ".bundle.js"
/******/ 	}
/******/
...
/***/ "./src/modules/helper/google-tag-manager/google-tag-manager.ts":
/*!*********************************************************************!*\
  !*** ./src/modules/helper/google-tag-manager/google-tag-manager.ts ***!
  \*********************************************************************/
/*! exports provided: GoogleTagManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GoogleTagManager", function() { return GoogleTagManager; });
/* harmony import */ var modules_helper_debug_debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! modules/helper/debug/debug */ "./src/modules/helper/debug/debug.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(GoogleTagManager, null, [{
    key: "init",
    value: function init() {
      GoogleTagManager.debug = new modules_helper_debug_debug__WEBPACK_IMPORTED_MODULE_0__["Debug"](true);
      if (!GoogleTagManager.datalayerExist()) return;
    }
  }, {
    key: "push",
    value: function push(datalayer) {
      if (!GoogleTagManager.datalayerExist()) return;
      GoogleTagManager.debug.group('GoogleTagManager - push()');
      GoogleTagManager.debug.log(datalayer);
      GoogleTagManager.debug.groupEnd();
      dataLayer.push(datalayer);
    }
  }, {
    key: "datalayerExist",
    value: function datalayerExist() {
      if (typeof dataLayer === 'undefined') {
        GoogleTagManager.debug.warn('Google Tag Manager is disabled because you are in dev environnement.');
        return false;
      }
...
_defineProperty(GoogleTagManager, "debug", void 0);
...
function () {
  ...
  _createClass(Responsive, null, [{
    ...
    value: function getMaxBreakpoint() {
      ...
      try {
        for (var _iterator = Responsive.maxBreakpoints[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function getMinBreakpoint() {
      ...
      try {
        for (var _iterator2 = Responsive.minBreakpoints[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function breakpointExist(breakpoint) {
      ...
      try {
        for (var _iterator3 = breakpoints[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
/***/ "./src/modules/offre/offre-liste/offre-liste.ts":
/*!******************************************************!*\
  !*** ./src/modules/offre/offre-liste/offre-liste.ts ***!
  \******************************************************/
/*! exports provided: OffreListe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OffreListe", function() { return OffreListe; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function OffreListe() {
    _classCallCheck(this, OffreListe);
  }

  _createClass(OffreListe, null, [{
    key: "init",
    value: function init() {
      if ($(".TerminauxList-list.offres").length > 0) {
        OffreListe.buildList(6);
      }
    ...
    key: "events",
    value: function events() {
      $(".TerminauxList-showMore.offres").on("click", function () {
        OffreListe.buildList(6);
      });
    }
  }, {
    ...
    value: function buildList() {
      var itemsToShow = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 6;
      var i = 0;
      var listItems = $(".TerminauxList-list.offres > div");
      ...
      if (i <= itemsToShow) {
        $(".TerminauxList-showMore.offres").hide();
      }
    }
  }]);
...
_defineProperty(OffreListe, "element", void 0);

_defineProperty(OffreListe, "$element", void 0);

_defineProperty(OffreListe, "slider", void 0);
...
/*!********************************************************!*\
  !*** ./src/modules/offre/offre-swiper/offre-swiper.ts ***!
  \********************************************************/
/*! exports provided: OffreSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OffreSwiper", function() { return OffreSwiper; });
...
/*#__PURE__*/
function () {
  function OffreSwiper() {
    _classCallCheck(this, OffreSwiper);
  }

  _createClass(OffreSwiper, null, [{
    key: "init",
    value: function init() {
      OffreSwiper.debug = new _helper_debug_debug__WEBPACK_IMPORTED_MODULE_0__["Debug"](true);
      OffreSwiper.$offreSwiper = $(".Offre-swiper");

      if (OffreSwiper.$offreSwiper.length > 0) {
        OffreSwiper.$offreSwiperItems = OffreSwiper.$offreSwiper.find(".OffreVariation");
        OffreSwiper.updateSwiper();
        OffreSwiper.events();
        OffreSwiper.showDetailOffre(0);
      }
    }
  }, {
    key: "events",
    value: function events() {
      ...
      $(".OffreVariation").on("click", function () {
        ...
        OffreSwiper.showDetailOffre($(this).index());
      });

      if (OffreSwiper.swiper) {
        OffreSwiper.swiper.on("slideChangeTransitionEnd", function () {
          OffreSwiper.setOffreNavBar();
        });
      }
    }
  }, {
    ...
    value: function updateSwiper() {
      ...
      if (_helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_1__["Responsive"].isMin("minLg")) {
        if (OffreSwiper.$offreSwiperItems.length > 4) {
          if (OffreSwiper.sliderType === "mobile") {
            OffreSwiper.destroySwiper();
          }

          OffreSwiper.createDesktopSwiper();
          OffreSwiper.sliderType = "desktop";
          this.debug.log('createDesktop');
        } else {
          OffreSwiper.destroySwiper();
          this.debug.log('destroy');
          OffreSwiper.sliderType = "";
        }
      } else {
        if (OffreSwiper.sliderType === "desktop") {
          OffreSwiper.destroySwiper();
        }

        OffreSwiper.createMobileSwiper();
        this.debug.log('createMobile');
        OffreSwiper.sliderType = "mobile";
      }
    }
  }, {
    key: "destroySwiper",
    value: function destroySwiper() {
      if (OffreSwiper.swiper) {
        ...
        OffreSwiper.swiper.destroy(true, true);
        OffreSwiper.swiper = null;
      }
    }
  }, {
    ...
    value: function createDesktopSwiper() {
      if (!OffreSwiper.swiper) {
        OffreSwiper.swiper = new swiper__WEBPACK_IMPORTED_MODULE_2___default.a(".Offre-swiper .swiper-container", {
          slidesPerView: 4,
          spaceBetween: 30,
          navigation: {
    ...
    value: function createMobileSwiper() {
      if (!OffreSwiper.swiper) {
        ...
        this.debug.log(_helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_1__["Responsive"].isMin("minLg"));
        OffreSwiper.swiper = new swiper__WEBPACK_IMPORTED_MODULE_2___default.a(".Offre-swiper .swiper-container", {
          slidesPerView: 1.2,
          spaceBetween: 10,
          centeredSlides: true,
    ...
    value: function showDetailOffre(indexOk) {
      var OffreButtons = $(".Offre-buttons");
    ...
    value: function setOffreNavBar() {
      var activeSlide = OffreSwiper.swiper.activeIndex;
      var nbSlides = OffreSwiper.swiper.slides.length;
      $(".OffreNavBar-activeSlide").text(activeSlide + 1);
      $(".OffreNavBar-nbSlides").text(nbSlides);
    }
  }]);
...
_defineProperty(OffreSwiper, "swiper", void 0);

_defineProperty(OffreSwiper, "debug", void 0);

_defineProperty(OffreSwiper, "sliderType", "");

_defineProperty(OffreSwiper, "$offreSwiper", void 0);

_defineProperty(OffreSwiper, "$offreSwiperItems", void 0);

/***/ }),

/***/ "./src/modules/terminaux/terminaux-details-choice/terminaux-details-choice.ts":
/*!************************************************************************************!*\
  !*** ./src/modules/terminaux/terminaux-details-choice/terminaux-details-choice.ts ***!
  \************************************************************************************/
/*! exports provided: TerminauxDetailsChoice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TerminauxDetailsChoice", function() { return TerminauxDetailsChoice; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var TerminauxDetailsChoice =
/*#__PURE__*/
function () {
  function TerminauxDetailsChoice() {
    _classCallCheck(this, TerminauxDetailsChoice);
  }

  _createClass(TerminauxDetailsChoice, null, [{
    key: "init",
    value: function init() {
      TerminauxDetailsChoice.$element = $(".TerminauxDetailsChoice");
      TerminauxDetailsChoice.element = TerminauxDetailsChoice.$element.get(0);

      if (TerminauxDetailsChoice.$element.length > 0) {
        TerminauxDetailsChoice.events();
        TerminauxDetailsChoice.defineColorAndStorageToSet();
        TerminauxDetailsChoice.setColorName();
      }
    }
  }, {
    key: "events",
    value: function events() {
      /* GESTION : COLORS / STORAGES */
      $(".ColorCircle").on("click", function () {
        if (!$(this).hasClass("disabled")) {
          var color = $(this).attr("data-color");

          if (color) {
            TerminauxDetailsChoice.setActiveColor($(this));
            TerminauxDetailsChoice.setStoragesFromColors(color);
          }
        }
      });
      $(".TerminauxDetailsChoice-stockage .item").on("click", function () {
        if (!$(this).hasClass("disabled")) {
          ...
          if (storage) {
            TerminauxDetailsChoice.setActiveStorage($(this));
            TerminauxDetailsChoice.setColorsFromStorages(storage);
          }
        }
      });
      /* BTN RADIO - FORFAIT */
      ...
      TerminauxDetailsChoice.$element.find(".TerminauxDetailsChoice-alertSubscription > form").on("submit", function (e) {
        e.preventDefault();
        var email = $(this).find('input[type="email"]').val().toString();

        if (TerminauxDetailsChoice.validateEmail(email)) {
          TerminauxDetailsChoice.showSuccess(email);
        }
      });
      $(".TerminauxInformations-seeMoreBtn").on("click", function () {
        $(".TerminauxInformations-specifications > li").css({
          display: "list-item"
        });
        $(this).hide();
      });
    ...
    key: "showSuccess",
    value: function showSuccess(email) {
      TerminauxDetailsChoice.$element.find(".TerminauxDetailsChoice-alertSubscription-input").hide();
      TerminauxDetailsChoice.$element.find(".TerminauxDetailsChoice-alertSubscription-submit").hide();
      TerminauxDetailsChoice.$element.find(".TerminauxDetailsChoice-alertSubscription-success").show();
      TerminauxDetailsChoice.$element.find(".TerminauxDetailsChoice-alertSubscription-success-content > span").text(email);
    }
  }, {
    key: "setStoragesFromColors",
    value: function setStoragesFromColors(color) {
      var detailsData = TerminauxDetailsChoice.$element.attr("data-details");
      detailsData = JSON.parse(detailsData); // console.log(detailsData);
      // console.log(color);

      var storagesArray = [];
      var storagesStockArray = [];
      $.each(detailsData, function (i, val) {
        if (color === val.color) {
          storagesArray.push(val.storageCapacity);
          storagesStockArray.push(val.inStock);
        }
      }); // console.log(storagesArray);
      // console.log(storagesStockArray);

      var it = 0;
      var $activeStockage = $(".TerminauxDetailsChoice-stockage .item.active");
      $(".TerminauxDetailsChoice-stockage .item").each(function () {
        $(this).removeClass("warning");
        $(this).find("span").html(""); // on retire tous les pictos de stock indisponible

        if ($.inArray($(this).attr("data-storage"), storagesArray) >= 0) {
          $(this).removeClass("disabled");

          if (storagesStockArray[it] === false) {
            TerminauxDetailsChoice.addWarningPictoForStorages($(this));
          }
      ...
      TerminauxDetailsChoice.selectValidStorage($activeStockage);
      TerminauxDetailsChoice.setPriceBlock();
    }
  }, {
    key: "setColorsFromStorages",
    value: function setColorsFromStorages(storage) {
      var detailsData = TerminauxDetailsChoice.$element.attr("data-details");
      detailsData = JSON.parse(detailsData); // console.log(detailsData);
      // console.log(storage);
      ...
      var colorsArray = [];
      $.each(detailsData, function (i, val) {
        if (storage === val.storageCapacity) {
          colorsArray.push(val.color);
        }
      });
      $(".ColorCircle ").each(function () {
        if ($.inArray($(this).attr("data-color"), colorsArray) >= 0) {// $(this).removeClass("disabled");
        } else {// $(this).addClass("disabled");
          }
      });
      TerminauxDetailsChoice.setWarningsForColors(detailsData);
      TerminauxDetailsChoice.setPriceBlock();
    }
  }, {
    key: "setActiveColor",
    value: function setActiveColor(el) {
      $(".ColorCircle").removeClass("isActive");
      el.addClass("isActive");
      TerminauxDetailsChoice.setColorName(el);
    }
  }, {
    key: "setActiveStorage",
    value: function setActiveStorage(el) {
      $(".TerminauxDetailsChoice-stockage .item").removeClass("active");
      el.addClass("active");
    }
  }, {
    key: "defineColorAndStorageToSet",
    value: function defineColorAndStorageToSet() {
      // RECUPERER LA COULEUR QUI A LA CLASSE : "isActive"
      var color = $(".ColorCircle.isActive").attr("data-color");
      TerminauxDetailsChoice.setStoragesFromColors(color); // RECUPERER LA COULEUR QUI A LA CLASSE : "active"

      var storage = $(".item.active").attr("data-storage");
      TerminauxDetailsChoice.setColorsFromStorages(storage);
      TerminauxDetailsChoice.setPriceBlock();
    }
  }, {
    key: "setPriceBlock",
    value: function setPriceBlock() {
      // console.log("setPriceBlock");
      // RECUPERATION DE LA COULEUR ACTIVE
      var $activeColorEl = $(".ColorCircle.isActive");
      var activeColor = $activeColorEl.attr("data-color"); // RECUPERATION DE LA CAPACITE ACTIVE

      var $activeStorageEl = $(".TerminauxDetailsChoice-stockage .item.active");
      var activeStorage = $activeStorageEl.attr("data-storage"); //console.log('activeStorage : ' + activeStorage);

      if ($activeColorEl.length > 0 && $activeStorageEl.length > 0) {
        // CAS OU IL Y A AU MOINS UNE COULEUR ET AU MOINS UN STOCKAGE
        $(".TerminauxDetailsChoice > .price").each(function () {
          if ($(this).attr("data-linkedcolor") === activeColor && $(this).attr("data-linkedstorage") === activeStorage) {
            $(this).show();
          } else {
            $(this).hide();
          }
        });
        $(".TerminauxDetailsChoice-alertSubscription").each(function () {
          if ($(this).attr("data-linkedcolor") === activeColor && $(this).attr("data-linkedstorage") === activeStorage) {
            $(this).show();
          } else {
            $(this).hide();
        ...
        $(".pageStyle-btn-forfait").each(function () {
          if ($(this).attr("data-linkedcolor") === activeColor && $(this).attr("data-linkedstorage") === activeStorage) {
            $(this).show();
          } else {
            $(this).hide();
      ...
      } else if ($activeColorEl.length > 0 && $activeStorageEl.length === 0) {
        // CAS OU IL Y A AU MOINS UNE COULEUR ET PAS DE STOCKAGE
        $(".TerminauxDetailsChoice > .price").each(function () {
          if ($(this).attr("data-linkedcolor") === activeColor) {
            $(this).show();
          } else {
            $(this).hide();
          }
        ...
        // CAS OU IL Y A MOINS UN STOCKAGE ET PAS DE COULEUR
        $(".TerminauxDetailsChoice > .price").each(function () {
          if ($(this).attr("data-linkedstorage") === activeStorage) {
            $(this).show();
          } else {
            $(this).hide();
          }
    ...
    key: "selectValidStorage",
    value: function selectValidStorage($currentStorage) {
      //console.log("CHECK STORAGE");
      if ($currentStorage.hasClass("disabled")) {
        var $nextSelectionnable = $currentStorage.nextAll(".item:not(.disabled)");
        var $prevSelectionnable = $currentStorage.prevAll(".item:not(.disabled)");
        var $bla = $currentStorage.siblings(); //console.log("Next", $nextSelectionnable);
        //console.log("Prev", $prevSelectionnable);

        if ($nextSelectionnable.length > 0) {
          $nextSelectionnable.eq(0).trigger("click");
        } else {
          $prevSelectionnable.eq(0).trigger("click");
        }
      }
    }
  }, {
    key: "addWarningPictoForStorages",
    value: function addWarningPictoForStorages(el) {
      var moduleDirectoryUri = $("body").attr("data-uri");
      /*el.find("span").html('<img class="TerminauxDetailsChoice-stockage-warning" src="' + moduleDirectoryUri + 'assets/icons/icon-info.svg" alt="">');*/

      el.addClass("warning");
    }
  }, {
    key: "setWarningsForColors",
    value: function setWarningsForColors(data) {
      var moduleDirectoryUri = $("body").attr("data-uri");
      $(".ColorCircle").each(function () {
        var $el = $(this);
        $el.find("span").html("");
        ...
        if (isAvailable === false) {
          /*$el.find("span").html('<img class="ColorCircle-warning" src="' + moduleDirectoryUri + 'assets/icons/icon-info.svg" alt="">');*/
          $el.addClass("warning");
        }
      });
    }
    ...
    key: "setColorName",
    value: function setColorName(el) {
      var colorName = "";

      if (el) {
        colorName = el.attr("data-name");
      } else {
        colorName = $(".ColorCircle.isActive").attr("data-name");
      }

      $(".TerminauxDetailsChoice-colors > .TerminauxDetailsChoice-cellTitle > span").text(colorName);
    }
  }]);

  return TerminauxDetailsChoice;
}();

_defineProperty(TerminauxDetailsChoice, "element", void 0);

_defineProperty(TerminauxDetailsChoice, "$element", void 0);

/***/ }),

/***/ "./src/modules/terminaux/terminaux-lightbox-swiper/product-details-preview.ts":
/*!************************************************************************************!*\
  !*** ./src/modules/terminaux/terminaux-lightbox-swiper/product-details-preview.ts ***!
  \************************************************************************************/
/*! exports provided: TerminauxDetailsPreview */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TerminauxDetailsPreview", function() { return TerminauxDetailsPreview; });
...
var TerminauxDetailsPreview =
/*#__PURE__*/
function () {
  function TerminauxDetailsPreview() {
    _classCallCheck(this, TerminauxDetailsPreview);
  }

  _createClass(TerminauxDetailsPreview, null, [{
    key: "init",
    value: function init() {
      TerminauxDetailsPreview.$element = $(".TerminauxDetailsChoice");
      TerminauxDetailsPreview.element = TerminauxDetailsPreview.$element.get(0);
      TerminauxDetailsPreview.swiperDefault = null;
      TerminauxDetailsPreview.swiperLightbox = null;

      if (TerminauxDetailsPreview.$element.length > 0) {
        TerminauxDetailsPreview.events();
        TerminauxDetailsPreview.initSwiperDefault();
        TerminauxDetailsPreview.initSwiperLightbox();
      }
    }
  }, {
    key: "events",
    value: function events() {
      $("#productLightbox").on("shown.bs.modal", function () {
        if (TerminauxDetailsPreview.swiperLightbox) {
          TerminauxDetailsPreview.swiperLightbox.update();
        }
      });
      $(".TerminauxDetailsPreview-default .swiper-slide").on("click", function () {
        var index = $(".TerminauxDetailsPreview-default .swiper-slide-active").index();
        TerminauxDetailsPreview.goToSlide(index);
      });
      $(".TerminauxDetailsPreview-default .TerminauxDetailsPreview-thumbnail-item").on("click", function () {
        TerminauxDetailsPreview.swiperDefault.slideTo($(this).index());
      });
      $(".TerminauxDetailsPreview-lightbox .TerminauxDetailsPreview-thumbnail-item").on("click", function () {
        TerminauxDetailsPreview.swiperLightbox.slideTo($(this).index());
      });
      $(".TerminauxDetailsPreview-videoBtn").on("click", function () {
        TerminauxDetailsPreview.goToSlide(3);
      });
    }
  }, {
    key: "initSwiperDefault",
    value: function initSwiperDefault() {
      TerminauxDetailsPreview.swiperDefault = new swiper__WEBPACK_IMPORTED_MODULE_0___default.a(".TerminauxDetailsPreview-default .swiper-container", {
        threshold: 20,
        on: {
          slideChange: function slideChange() {
            TerminauxDetailsPreview.goToSlide(TerminauxDetailsPreview.swiperDefault.realIndex);
          }
        }
      });
    }
  }, {
    key: "initSwiperLightbox",
    value: function initSwiperLightbox() {
      TerminauxDetailsPreview.swiperLightbox = new swiper__WEBPACK_IMPORTED_MODULE_0___default.a(".TerminauxDetailsPreview-lightbox .swiper-container", {
        navigation: {
          nextEl: ".swiper-preview-next",
          prevEl: ".swiper-preview-prev"
        },
        pagination: {
          el: ".swiper-preview-pagination-y",
          clickable: false
        },
        threshold: 20,
        on: {
          // AFFICHAGE / MASQUAGE DES FLECHES
          init: function init() {
            if (this.activeIndex === 0) {
              TweenMax.to($(".TerminauxDetailsPreview .swiper-preview-prev"), 0.5, {
                autoAlpha: 0
              });
            } else {
              TweenMax.to($(".TerminauxDetailsPreview .swiper-preview-prev"), 0.5, {
            ...
            if (this.activeIndex === 3) {
              TweenMax.to($(".TerminauxDetailsPreview .swiper-preview-next"), 0.5, {
                autoAlpha: 0
              });
            } else {
              TweenMax.to($(".TerminauxDetailsPreview .swiper-preview-next"), 0.5, {
          ...
          slideChange: function slideChange() {
            // @ts-ignore HTMLIFrameElement
            $('.TerminauxDetailsPreview-iframe')[0].contentWindow.postMessage('{"event":"command","func":"' + 'pauseVideo' + '","args":""}', '*');
    ...
    value: function goToSlide() {
      ...
      TerminauxDetailsPreview.swiperLightbox.slideTo(slide);
    }
  }]);

  return TerminauxDetailsPreview;
}();

_defineProperty(TerminauxDetailsPreview, "element", void 0);

_defineProperty(TerminauxDetailsPreview, "$element", void 0);

_defineProperty(TerminauxDetailsPreview, "swiperDefault", void 0);

_defineProperty(TerminauxDetailsPreview, "swiperLightbox", void 0);

/***/ }),

/***/ "./src/modules/terminaux/terminaux-lightbox/terminaux-lightbox.ts":
/*!************************************************************************!*\
  !*** ./src/modules/terminaux/terminaux-lightbox/terminaux-lightbox.ts ***!
  \************************************************************************/
/*! exports provided: TerminauxLightbox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TerminauxLightbox", function() { return TerminauxLightbox; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var TerminauxLightbox =
/*#__PURE__*/
function () {
  function TerminauxLightbox() {
    _classCallCheck(this, TerminauxLightbox);
  }

  _createClass(TerminauxLightbox, null, [{
    key: "init",
    value: function init() {
      TerminauxLightbox.$element = $(".TerminauxLightbox");
      TerminauxLightbox.element = TerminauxLightbox.$element.get(0);

      if (TerminauxLightbox.$element.length) {
        TerminauxLightbox.events();
      }
    }
  }, {
    key: "events",
    value: function events() {
      $('.TerminauxLightbox-close').on('click', function () {
        $('#productLightbox').modal('toggle');
      });
    }
  }]);

  return TerminauxLightbox;
}();

_defineProperty(TerminauxLightbox, "element", void 0);

_defineProperty(TerminauxLightbox, "$element", void 0);

/***/ }),

/***/ "./src/modules/terminaux/terminaux-liste/terminaux-liste.ts":
/*!******************************************************************!*\
  !*** ./src/modules/terminaux/terminaux-liste/terminaux-liste.ts ***!
  \******************************************************************/
/*! exports provided: TerminauxListe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TerminauxListe", function() { return TerminauxListe; });
...
/*#__PURE__*/
function () {
  function TerminauxListe() {
    _classCallCheck(this, TerminauxListe);
  }

  _createClass(TerminauxListe, null, [{
    key: "init",
    value: function init() {
      if ($(".TerminauxList-list.terminaux").length > 0) {
        TerminauxListe.buildList(6);
      }

      TerminauxListe.slider = document.getElementById("windowFilter-range");
      TerminauxListe.$element = $('.WindowFilter');

      if (TerminauxListe.$element.length === 0) {
        return;
      }

      TerminauxListe.element = TerminauxListe.$element.get(0);
      TerminauxListe.events();
      TerminauxListe.initNoUiSlider();
    }
  }, {
    key: "events",
    value: function events() {
      $("#productFilter").on("click", function (event) {
        event.stopPropagation();

        if (TerminauxListe.$element.hasClass("open")) {
          if ($("html").attr("dir") === "rtl") {
            TweenMax.to(TerminauxListe.$element, 0.5, {
              x: "100%",
              ease: Power3.easeOut
            });
          } else {
          ...
          TerminauxListe.$element.removeClass("open");
        } else {
          TweenMax.to(TerminauxListe.$element, 0.5, {
            x: "0%",
            ease: Power3.easeOut
          });
          TerminauxListe.$element.addClass("open");
        }
      });
      $("#WindowFilter").on("click", function (event) {
        event.stopPropagation();
      });
      $(window).on("mousedown", function (event) {
        if (!$(event.target).is("#productFilter") && $(event.target).closest(TerminauxListe.$element).length === 0) {
      ...
      $(".WindowFilter-header-backBtn").on("click", function () {
        if (TerminauxListe.$element.hasClass("open")) {
          TerminauxListe.$element.removeClass("open");
      ...
      $(".TerminauxList-showMore.terminaux").on("click", function () {
        TerminauxListe.buildList(6);
      });
      /* TEXT INPUTS => FORCE NUMBERS */

      TerminauxListe.$element.find("input#inputPriceMin").on("input", function () {
        var value = $(this).val().toString();

        if (/\D/.test(value)) {
          value = value.replace(/\D/g, '');
          TerminauxListe.$element.find("input#inputPriceMin").val(value);
        }

        if ($(".WindowFilter-range").hasClass("noUi-target")) {
          TerminauxListe.slider.noUiSlider.set([value, null]);
        }
      });
      TerminauxListe.$element.find("input#inputPriceMax").on("input", function () {
        var value = $(this).val().toString();

        if (/\D/.test(value)) {
          value = value.replace(/\D/g, '');
          TerminauxListe.$element.find("input#inputPriceMax").val(value);
        }

        if ($(".WindowFilter-range").hasClass("noUi-target")) {
          TerminauxListe.slider.noUiSlider.set([null, value]);
        }
      });
      /* WINDOW FILTER SUBMIT */

      TerminauxListe.$element.find("form").on("submit", function (e) {
        e.preventDefault();
        ...
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"); //console.log(formData);
    ...
    value: function buildList() {
      var itemsToShow = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 6;
      var i = 0;
      var listItems = $(".TerminauxList-list.terminaux > div");
      listItems.each(function () {
        if ($(this).attr("data-visibility") !== "visible") {
          i++;
    ...
    key: "initNoUiSlider",
    value: function initNoUiSlider() {
      var componentDirection = "ltr";

      if ($("html").attr("dir") === "rtl") {
        componentDirection = "rtl";
      }

      nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(TerminauxListe.slider, {
        start: [0, 1000000],
        connect: true,
      ...
      TerminauxListe.slider.noUiSlider.on("update", function (values, handle) {
        var handleLeftVal = Math.round(values[0]);
        var handleRightVal = Math.round(values[1]);
        $("#inputPriceMin").val(handleLeftVal);
        $("#inputPriceMax").val(handleRightVal);
      });
    }
  }]);

  return TerminauxListe;
}();

_defineProperty(TerminauxListe, "element", void 0);

_defineProperty(TerminauxListe, "$element", void 0);

_defineProperty(TerminauxListe, "slider", void 0);

/***/ }),

/***/ "./src/modules/ui/bloc-associated-product/bloc-associated-product.ts":
/*!***************************************************************************!*\
  !*** ./src/modules/ui/bloc-associated-product/bloc-associated-product.ts ***!
  \***************************************************************************/
/*! exports provided: AssociatedProduct */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssociatedProduct", function() { return AssociatedProduct; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function AssociatedProduct() {
    _classCallCheck(this, AssociatedProduct);
  }

  _createClass(AssociatedProduct, null, [{
    key: "init",
    value: function init() {
      AssociatedProduct.$element = $(".AssociatedProduct");
      AssociatedProduct.element = AssociatedProduct.$element.get(0);

      if (AssociatedProduct.$element.length) {
        AssociatedProduct.events();
      }
    }
  }, {
    key: "events",
    value: function events() {
      $('.BlocAssociatedProductLightbox-close').on('click', function () {
        $('#blocAssociatedProductLightbox').modal('toggle');
      });
    }
  }]);
...
_defineProperty(AssociatedProduct, "element", void 0);
...
/*!*****************************************************!*\
  !*** ./src/modules/ui/bloc-onglets/bloc-onglets.ts ***!
  \*****************************************************/
/*! exports provided: BlocOnglets */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BlocOnglets", function() { return BlocOnglets; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(BlocOnglets, null, [{
    ...
    value: function init() {
      ...
      BlocOnglets.$tabHeading = BlocOnglets.$element.find(".o-tab-heading");
    ...
    value: function events() {
      ...
      BlocOnglets.$tabHeading.on("click", function (e) {
        var $this = $(this);
        var $tabToShow = $this.find(".Onglets-showWhenTabIsOpenned");
        var $tabToHide = $this.find(".Onglets-hideWhenTabIsOpenned");
    ...
    value: function hideAllTabs() {
      BlocOnglets.$tabHeading.each(function (index, value) {
        var $this = $(this);
        var $tabToHide = $this.find(".Onglets-showWhenTabIsOpenned");
        var $tabToShow = $this.find(".Onglets-hideWhenTabIsOpenned");
        $tabToHide.css({
          display: "none"
        });
        $tabToShow.css({
    ...
    value: function setTabs() {
      ...
      if ($(".TerminauxInformations").length > 0) {
        BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(0)").addClass("show");
        BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(0)").attr("aria-expanded", "true");
      } else {
        var windowWidth = $(window).width();

        if (windowWidth >= 980) {
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(0)").removeClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(1)").addClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(2)").removeClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(3)").removeClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(0)").attr("aria-expanded", "false");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(1)").attr("aria-expanded", "true");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(2)").attr("aria-expanded", "false");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(3)").attr("aria-expanded", "false");
        } else {
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(0)").addClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(1)").removeClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(2)").removeClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-content:eq(3)").removeClass("show");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(0)").attr("aria-expanded", "true");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(1)").attr("aria-expanded", "false");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(2)").attr("aria-expanded", "false");
          BlocOnglets.$blocOngletsOffres.find(".o-tab-heading:eq(3)").attr("aria-expanded", "false");
        }
      }
...
/***/ "./src/modules/ui/home-search/home-search.ts":
/*!***************************************************!*\
  !*** ./src/modules/ui/home-search/home-search.ts ***!
  \***************************************************/
/*! exports provided: HomeSearch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeSearch", function() { return HomeSearch; });
/* harmony import */ var src_vendors_greensock_js_shockingly_green_src_bonus_files_for_npm_users_umd_SplitText_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/vendors/greensock-js-shockingly-green/src/bonus-files-for-npm-users/umd/SplitText.js */ "./src/vendors/greensock-js-shockingly-green/src/bonus-files-for-npm-users/umd/SplitText.js");
/* harmony import */ var src_vendors_greensock_js_shockingly_green_src_bonus_files_for_npm_users_umd_SplitText_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(src_vendors_greensock_js_shockingly_green_src_bonus_files_for_npm_users_umd_SplitText_js__WEBPACK_IMPORTED_MODULE_0__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(HomeSearch, null, [{
    key: "init",
    value: function init() {
      HomeSearch.$element = $(".HomeSearch");
      HomeSearch.element = HomeSearch.$element.get(0);

      if (HomeSearch.$element.length > 0) {
        HomeSearch.events();
      }
    }
  }, {
    key: "events",
    value: function events() {
      HomeSearch.selectKeyword(0);
      HomeSearch.$element.find(".HomeSearch-input").on("focusin", function () {
        $("#quote").hide();
      });
      HomeSearch.$element.find(".HomeSearch-input").on("focusout", function () {
        if (!$(this).val()) {
          $("#quote").show();
        }
      });
    ...
    key: "selectKeyword",
    value: function selectKeyword(index) {
      var keywords = HomeSearch.$element.find(".HomeSearch-input").attr("data-keywords");
      var keywordsArray1 = keywords.split('"');
      var keywordsArray2 = [];
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
      ...
      try {
        for (var _iterator = keywordsArray1[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var item = _step.value;

          if (item.trim().length >= 2) {
            keywordsArray2.push(item);
          }
        }
      } catch (err) {
        _didIteratorError = true;
      ...
      if (index >= keywordsArray2.length) {
        index = 0;
      }

      HomeSearch.writeKeyword(keywordsArray2[index]);
      HomeSearch.animateKeyword(index, keywordsArray2[index]);
    }
  }, {
    key: "writeKeyword",
    value: function writeKeyword(keyword) {
      HomeSearch.$element.find("#quote > span").text(keyword);
    }
  }, {
    key: "animateKeyword",
    value: function animateKeyword(index, keyword) {
      var mySplitText = new src_vendors_greensock_js_shockingly_green_src_bonus_files_for_npm_users_umd_SplitText_js__WEBPACK_IMPORTED_MODULE_0__("#quote > span", {
        type: "chars"
      });
      TweenMax.staggerFrom(mySplitText.chars, 1, {
        opacity: 0
      }, 0.1, allDone);

      function allDone() {
        index++;
        HomeSearch.selectKeyword(index);
      }
    }
  }]);
...
_defineProperty(HomeSearch, "element", void 0);
...
/* harmony import */ var scss_abstract_variables_scss_js__WEBPACK_IMPORTED_MODULE_150__ = __webpack_require__(/*! scss/abstract/_variables.scss.js */ "./src/scss/abstract/_variables.scss.js");
/* harmony import */ var scss_abstract_variables_scss_js__WEBPACK_IMPORTED_MODULE_150___default = /*#__PURE__*/__webpack_require__.n(scss_abstract_variables_scss_js__WEBPACK_IMPORTED_MODULE_150__);
/* harmony import */ var modules_helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_151__ = __webpack_require__(/*! modules/helper/responsive/responsive */ "./src/modules/helper/responsive/responsive.ts");
/* harmony import */ var modules_helper_google_tag_manager_google_tag_manager__WEBPACK_IMPORTED_MODULE_152__ = __webpack_require__(/*! modules/helper/google-tag-manager/google-tag-manager */ "./src/modules/helper/google-tag-manager/google-tag-manager.ts");
/* harmony import */ var modules_helper_debug_debug__WEBPACK_IMPORTED_MODULE_153__ = __webpack_require__(/*! modules/helper/debug/debug */ "./src/modules/helper/debug/debug.ts");
/* harmony import */ var modules_helper_svg_loader_svg_loader__WEBPACK_IMPORTED_MODULE_154__ = __webpack_require__(/*! modules/helper/svg.loader/svg.loader */ "./src/modules/helper/svg.loader/svg.loader.ts");
/* harmony import */ var _modules_menu_desktop_menu_desktop__WEBPACK_IMPORTED_MODULE_155__ = __webpack_require__(/*! ../modules/menu-desktop/menu-desktop */ "./src/modules/menu-desktop/menu-desktop.ts");
/* harmony import */ var _modules_menu_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_156__ = __webpack_require__(/*! ../modules/menu-mobile/menu-mobile */ "./src/modules/menu-mobile/menu-mobile.ts");
/* harmony import */ var _modules_ui_home_search_home_search__WEBPACK_IMPORTED_MODULE_157__ = __webpack_require__(/*! ../modules/ui/home-search/home-search */ "./src/modules/ui/home-search/home-search.ts");
/* harmony import */ var _modules_ui_nav_search_nav_search__WEBPACK_IMPORTED_MODULE_158__ = __webpack_require__(/*! ../modules/ui/nav-search/nav-search */ "./src/modules/ui/nav-search/nav-search.ts");
/* harmony import */ var _modules_terminaux_terminaux_liste_terminaux_liste__WEBPACK_IMPORTED_MODULE_159__ = __webpack_require__(/*! ../modules/terminaux/terminaux-liste/terminaux-liste */ "./src/modules/terminaux/terminaux-liste/terminaux-liste.ts");
/* harmony import */ var _modules_terminaux_terminaux_lightbox_terminaux_lightbox__WEBPACK_IMPORTED_MODULE_160__ = __webpack_require__(/*! ../modules/terminaux/terminaux-lightbox/terminaux-lightbox */ "./src/modules/terminaux/terminaux-lightbox/terminaux-lightbox.ts");
/* harmony import */ var _modules_terminaux_terminaux_lightbox_swiper_product_details_preview__WEBPACK_IMPORTED_MODULE_161__ = __webpack_require__(/*! ../modules/terminaux/terminaux-lightbox-swiper/product-details-preview */ "./src/modules/terminaux/terminaux-lightbox-swiper/product-details-preview.ts");
/* harmony import */ var _modules_terminaux_terminaux_details_choice_terminaux_details_choice__WEBPACK_IMPORTED_MODULE_162__ = __webpack_require__(/*! ../modules/terminaux/terminaux-details-choice/terminaux-details-choice */ "./src/modules/terminaux/terminaux-details-choice/terminaux-details-choice.ts");
/* harmony import */ var _modules_offre_offre_liste_offre_liste__WEBPACK_IMPORTED_MODULE_163__ = __webpack_require__(/*! ../modules/offre/offre-liste/offre-liste */ "./src/modules/offre/offre-liste/offre-liste.ts");
/* harmony import */ var _modules_offre_offre_swiper_offre_swiper__WEBPACK_IMPORTED_MODULE_164__ = __webpack_require__(/*! ../modules/offre/offre-swiper/offre-swiper */ "./src/modules/offre/offre-swiper/offre-swiper.ts");
/* harmony import */ var modules_ui_bloc_onglets_bloc_onglets__WEBPACK_IMPORTED_MODULE_165__ = __webpack_require__(/*! modules/ui/bloc-onglets/bloc-onglets */ "./src/modules/ui/bloc-onglets/bloc-onglets.ts");
/* harmony import */ var _modules_ui_bloc_associated_product_bloc_associated_product__WEBPACK_IMPORTED_MODULE_166__ = __webpack_require__(/*! ../modules/ui/bloc-associated-product/bloc-associated-product */ "./src/modules/ui/bloc-associated-product/bloc-associated-product.ts");
...
var themeImport = [scss_abstract_variables_scss_js__WEBPACK_IMPORTED_MODULE_150__];
// Helper
...
$(function () {
  modules_helper_debug_debug__WEBPACK_IMPORTED_MODULE_153__["Debug"]._enabled = false; // Helper

  modules_helper_responsive_responsive__WEBPACK_IMPORTED_MODULE_151__["Responsive"].init(scss_abstract_variables_scss_js__WEBPACK_IMPORTED_MODULE_150__["breakpoints"]);
  modules_helper_svg_loader_svg_loader__WEBPACK_IMPORTED_MODULE_154__["SvgLoader"].init();
  modules_helper_google_tag_manager_google_tag_manager__WEBPACK_IMPORTED_MODULE_152__["GoogleTagManager"].init();
  modules_ui_bloc_onglets_bloc_onglets__WEBPACK_IMPORTED_MODULE_165__["BlocOnglets"].init();
  _modules_terminaux_terminaux_liste_terminaux_liste__WEBPACK_IMPORTED_MODULE_159__["TerminauxListe"].init();
  _modules_offre_offre_liste_offre_liste__WEBPACK_IMPORTED_MODULE_163__["OffreListe"].init();
  _modules_terminaux_terminaux_lightbox_terminaux_lightbox__WEBPACK_IMPORTED_MODULE_160__["TerminauxLightbox"].init();
  _modules_offre_offre_swiper_offre_swiper__WEBPACK_IMPORTED_MODULE_164__["OffreSwiper"].init();
  _modules_terminaux_terminaux_details_choice_terminaux_details_choice__WEBPACK_IMPORTED_MODULE_162__["TerminauxDetailsChoice"].init();
  _modules_ui_bloc_associated_product_bloc_associated_product__WEBPACK_IMPORTED_MODULE_166__["AssociatedProduct"].init();
  _modules_menu_desktop_menu_desktop__WEBPACK_IMPORTED_MODULE_155__["MenuDesktop"].init();
  _modules_menu_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_156__["MenuMobile"].init();
  _modules_terminaux_terminaux_lightbox_swiper_product_details_preview__WEBPACK_IMPORTED_MODULE_161__["TerminauxDetailsPreview"].init(); // Search

  _modules_ui_home_search_home_search__WEBPACK_IMPORTED_MODULE_157__["HomeSearch"].init();
  _modules_ui_nav_search_nav_search__WEBPACK_IMPORTED_MODULE_158__["NavSearch"].init(); //SearchMenu.init();
  //SearchAlgolia.init();
  //SearchAlgolia.search("Samsung","products");
  //SearchModal.init();
  ...
  } // Category SearchMenu Swiper
  //const $searchMenuSwiper = $(".searchNav");
  //if ($searchMenuSwiper.length > 0) {
  //  import(/* webpackChunkName: "searchMenu" */ "modules/ui/searchMenu/searchMenu").then((module) => {
  //    const SearchMenu = module.SearchMenu;
  //    SearchMenu.init();
  //  });
  //}
  // COUNTER
  ...
  } // Boosted Arrow Collapse Animation
...
/***/ "./src/vendors/greensock-js-shockingly-green/src/bonus-files-for-npm-users/umd/SplitText.js":
/*!**************************************************************************************************!*\
  !*** ./src/vendors/greensock-js-shockingly-green/src/bonus-files-for-npm-users/umd/SplitText.js ***!
  \**************************************************************************************************/
/*! no static exports found */
