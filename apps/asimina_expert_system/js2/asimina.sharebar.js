JSShare = {
    ...
    go: function(element, options) {
        var self = JSShare,
            ...
            defaultOptions = {
                ...
                twitter_message: getMetaContent("name='twitter:message'"),
                twitter_site: getMetaContent("name='twitter:site'"),
                email_subject: getMetaContent("name='email:subject'"),
                email_message: getMetaContent("name='email:message'")
            };
    ...
    email: function(options) {
        return 'mailto:?'
            + 'subject=' + encodeURIComponent(options.email_subject)
...
function initSharebar(selector = '.__sharebar'){
    var sharebarHtml = `<div class="DetailsNews-socialNetworks"><div class=\"SocialNetworks isLight\">
            <span class=\"SocialNetworks-title\">Partager sur</span>
