...
(function (util){
    ...
    util.getCollapse = function(collapseId,label){
        ...
        var button = util.createElement("button",
                                {"type":"button","class":"btn btn-link btn-lg btn-block text-left text-light","data-toggle":"collapse","href":"#" + collapseId,"role":"button","aria-expanded":"false","aria-controls":collapseId},
                                null,label);
...
(function( variants ) {
    ...
    var variantView = function(id,selector,variantData,index,isPriceTaxIncluded,taxPercentage,constants){
        ...
        var buttonHeading = createElement("button",
                                            {"class":"btn btn-link btn-lg btn-block text-left text-white","type":"button","data-toggle":"collapse","href":"#collapse" + id,"role":"button","aria-expanded":"false","aria-controls":"collapse" + id},
                                            null,getHeadingText());
        ...
        var cardBody = createElement("div",{"class":"card-body collapse show mb-2","id":'collapse'+id})
