                        ...
                        <div class="card mb-2">
                            ...
                            <div class="collapse show pt-3" id="globalInfoCollapse">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Path prefix</label>
                                        <div class="col-sm-9">
...
<script type="text/javascript">
        ...
        if(typeof folderData === 'undefined' ){
            ...
            if(typeof pathPrefixObj == 'object'){
                $.each(pathPrefixObj, function(curLangId, curPathPrefix){
                    var pathPrefixInput = form.find('[name=path_prefix]');
    ...
    function onSaveFolder(){
        let modal = $('#modalAddEditFolder');
        let form = $('#formAddEditFolder');
        let id =  form.find('[name=id]').val();
        if($('#folderLevel').val() < '<%=com.etn.asimina.util.UIHelper.escapeCoteValue(maxFolderLevel+"")%>' || id){

            let parentFolderUuid =  $('#folderUuid').val();
            let catalogId =  '<%=com.etn.asimina.util.UIHelper.escapeCoteValue(rootCatalog+"")%>';
