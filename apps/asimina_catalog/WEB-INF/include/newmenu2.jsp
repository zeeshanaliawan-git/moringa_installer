...
<%
        String whereClause = "";
        if(!parseNull(com.etn.beans.app.GlobalParm.getParm("ENABLE_ECOMMERCE")).equals("1")) whereClause = " and url not like '%shop_parameters.jsp' and url not like '%_shop/%' and url not like '%_prodshop/%' ";
	Set ____rsp = Etn.execute("select case coalesce(parent,'') when '' then name else parent end as _parent, " +
...
<nav class="navbar navbar-dark bg-dark navbar-expand-md fixed-top">
	<div class="container">
			...
			<a class="navbar-brand" href="<%=request.getContextPath()%>/admin/gestion.jsp">
...
%>
			...
			<% while(____rs1.next()) {
				...
				String ____target = "";
				if("1".equals(____rs1.value("new_tab"))) ____target = " target='_blank' ";
                                //if(____u.contains("shop_parameters.jsp")||____u.contains("_shop/")||____u.contains("_prodshop/")) continue;
			%>
