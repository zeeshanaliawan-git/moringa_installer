    ...
    <div class="container">
        ...
        <form class="form-horizontal" autocomplete="off"  id='frm' action='<%=request.getContextPath()%>/forgotpassword.jsp' >
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-7'><input class='form-control' type='text' disabled name='username' id='username' value='<%=username%>' autocomplete='off'/></div>
            </div>
            <div class='form-group row'>
                <label for='password' class='col-sm-3 control-label text-right'>New Passwrod&nbsp;<span style='color:red'>*</span></label>
