...
<%
	...
	{
		String qry = "update external_phases set width = " + escape.cote(width) + ", height = " + escape.cote(height) + " where start_proc = '" + replaceQoute(process) + "' and next_proc = '"+replaceQoute(targetProcess)+"' and next_phase = '" + replaceQoute(phase)+ "'";
