...
<%
	Set rs = Etn.execute("select * from "+GlobalParm.getParm("COMMONS_DB")+".user_sessions where is_publish_prod_login = 1 and menu_session_id = " + escape.cote(session.getId()));
