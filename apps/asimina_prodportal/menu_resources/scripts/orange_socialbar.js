        ...
        if(visible_sharebar_buttons[i].button === 'email'){
            if(visible_sharebar_buttons[i].mailto === false){
                if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	        		if(sharebar_parameters.og_locale == "ar_AR"){
	        			sharebarHTML += "<a href=\"mailto:?subject=" + sharebar_parameters.email_subject + "&cc=&bcc=&body=" + sharebar_parameters.email_message + "\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">email " + staticTextLocale.accessibility.sharewith + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";
	        		}else{
	        			sharebarHTML += "<a href=\"mailto:?subject=" + sharebar_parameters.email_subject + "&cc=&bcc=&body=" + sharebar_parameters.email_message + "\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.sharewith + " email</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";
	        		}
                }else{
	        		if(sharebar_parameters.og_locale == "ar_AR"){
                    sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">email " + staticTextLocale.accessibility.sharewith + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";
	        		}else{
                    sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.sharewith + " email</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";	
	        		}
	        ...
	        if(getDeviceAndVersion().os == "iOS" && getDeviceAndVersion().version != 7){
	        	if(sharebar_parameters.og_locale == "ar_AR"){
					sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">SMS " + staticTextLocale.accessibility.sharewith + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.sms + "</svg></a>";
	        	}else{
		            sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.sharewith + " SMS</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.sms + "</svg></a>";
	        	}
	        }
        }else{
            ...
            if(sharebar_parameters.og_locale === "ar_AR"){
        		sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + currentButton + " " + staticTextLocale.accessibility.shareon + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}else{
            	sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', 'sharebar_visited', 730);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.shareon + " " + currentButton + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}
        }
    }
    sharebarHTML += "</div>";
...
var showFollowBar = function(){
    ...
    for(var i=0, len=visible_followbar_buttons.length;i<len;i++){
        ...
        if(currentSVGIcon != null && currentFollowPage != null && currentSVGIcon != "" && currentFollowPage != ""){
        	if(currentButton == "newsletter"){
				followbarHTML += "<a href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', 'followbar_visited', 730);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.newsletter + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}else{
        		if(followbar_parameters.og_locale == "ar_AR"){
        			followbarHTML += "<a href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', 'followbar_visited', 730);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + currentButton + " " + staticTextLocale.accessibility.follow + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        		}else{
        			followbarHTML += "<a href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', 'followbar_visited', 730);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.follow + " " + currentButton + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        		}
        	}
        }
    }
    ...
    if($("#followbar.second").length != 0){
        $("#followbar.second").html(followbarHTML);
        if(followbar_parameters.background_color != null && followbar_parameters.layout != null){
            $("#followbar.second").addClass(followbar_parameters.background_color + ' ' + followbar_parameters.layout);
        }        
    }
...
window.onload = function(){
    ...
    if($('#followbar.horizontal.second').length){
        $("#followbar.horizontal.second #follow")[0].style.minWidth = Math.round($("#followbar.horizontal.second #follow")[0].offsetWidth) + "px";
    }
	if($(document).width() < 480){
		if($('#sharebar.horizontal').length){
	  		$("#sharebar.horizontal .content")[0].style.maxWidth = "calc(100% - " + ($('#sharebar.horizontal #counterlabel')[0].offsetWidth + 13) + "px)";
	  	}
        if($('#followbar.horizontal').length){
            $("#followbar.horizontal .content")[0].style.maxWidth = "calc(100% - " + ($('#followbar.horizontal #follow')[0].offsetWidth + 13) + "px)";
        }
        if($('#followbar.horizontal.second').length){
            $("#followbar.horizontal.second .content")[0].style.maxWidth = "calc(100% - " + ($('#followbar.horizontal.second #follow')[0].offsetWidth + 13) + "px)";
        }
        ...
        if($('#followbar.horizontal.second').length){
            $("#followbar.horizontal.second .content")[0].style.maxWidth = "calc(100% - " + ($('#followbar.horizontal.second #follow')[0].offsetWidth + 0.0256*$(document).width() + 1) + "px)";
        }
        ...
        if($('#followbar.horizontal.second').length){
            $("#followbar.horizontal.second .content")[0].style.maxWidth = "calc(100% - " + ($('#followbar.horizontal.second #follow')[0].offsetWidth + 0.0327*$(document).width() + 1) + "px)";
        }
	}else{
		if($('#sharebar.horizontal').length){
        ...
        if($('#followbar.horizontal.second').length){
            $("#followbar.horizontal.second .content")[0].style.maxWidth = "calc(100% - " + ($('#followbar.horizontal.second #follow')[0].offsetWidth + 20) + "px)";
        }
	}
