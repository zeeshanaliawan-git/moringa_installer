...
//        System.out.println(lang+"lang");
	...
	boolean anyamountshown = false;
       ...
       taxpercentage.output_with_tax = showamountwithtax;
        ...
        System.out.println(rs.value("combo_prices") + " COMBO" + combo_key);
        ...
        String price_value = getPrice(price, bt, taxpercentage,price_diff,quantity, rs.value("bundle_prices"), logged, pdiscount.getProductDiscount(), pdiscount.getProductDiscountType(), pdiscount.getCatalogDiscount(), pdiscount.getCatalogDiscountType(), pdiscount.getOverallDiscount(), pdiscount.getOverallDiscountType());
        String promo_price_value = getPrice(promo_price, bt, taxpercentage,price_diff,quantity, rs.value("bundle_prices"), logged, pdiscount.getProductDiscount(), pdiscount.getProductDiscountType(), pdiscount.getCatalogDiscount(), pdiscount.getCatalogDiscountType(), pdiscount.getOverallDiscount(), pdiscount.getOverallDiscountType());
