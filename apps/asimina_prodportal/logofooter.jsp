<%
	//define variables ___muuid and _error_msg in original jsps 
	...
	String _headerHtml = "", _footerHtml = "", _menuid = "", _lang = "", _headhtml = "", 	_endscriptshtml = "", _title = "", _favicon = "", ___loadedsiteid = "", ___showloginbar = "", __searchapi="", ___authPageUrl = "";
	String __searchcompletionurl = "", __searchurl = "", __searchparams = "", ____menuVersion = "V1", ____publishedHpUrl = "", ___loadedlangid = "", ___ptemplateid = "", ___loadedsiteuuid = "",___ecommerceEnabled = "";
	...
	{    
		...
		if("V1".equalsIgnoreCase(____menuVersion))
		{
			...
			_headerHtml = "<div class=\"TunnelHeader\"><div class=\"container-lg\"><div class=\"TunnelHeader-wrapper\">"
                    + "<a href=\"javascript:__gotoPortalHome();\" class=\"TunnelHeader-brand\"><img class=\"TunnelHeader-brand-large\" src=\""+com.etn.beans.app.GlobalParm.getParm("EXTERNAL_LINK")+"menu_resources/uploads/"+_menuRs.value("logo_file")+"\" alt=\"logo\"><img class=\"TunnelHeader-brand-small\" src=\""+com.etn.beans.app.GlobalParm.getParm("EXTERNAL_LINK")+"menu_resources/uploads/"+_menuRs.value("small_logo_file")+"\" alt=\"logo\"></a>"
                    + "<div class=\"TunnelHeader-title\">"+com.etn.asimina.util.LanguageHelper.getInstance().getTranslation(Etn, "Commande")+"</div></div></div></div>";
                    //+"<div style=\"width:100%;\" class=\"o-navbar o-black o-sticky o-h80 o-border-bottom\" id=\"o-secondtopmenu\" data-lf-top-fixed=\"\"><div class=\"o-container\"><a class=\"___portalmenulink\" id=\"___portalhomepagelink\" href=\"\" target=\"_self\"><img src=\""+com.etn.beans.app.GlobalParm.getParm("EXTERNAL_LINK")+"menu_resources/uploads/"+_menuRs.value("logo_file")+"\" alt=\"logo\" class=\"o-logo\"></a><span class=\"o-f18 o-col3 o-color-white o-dib o-main\" style=\"vertical-align: bottom; font-weight: bold; font-size:20pt;\"></span></div></div>";
		}		
	}
	else
	{
		...
		if("1".equals(_menuRs.value("show_login_bar")) || "1".equals(_menuRs.value("enable_cart"))) 
		{
			...
			if("1".equals(_menuRs.value("enable_cart"))) 
			{
				...
				_endscriptshtml += "__loadcart();\n";
					...
					_endscriptshtml += "$(\".etnhf-HomeFooter\").css(\"margin-top\",60);\n";
					//_endscriptshtml += "$(\"body\").addClass(\"isWithoutMenu\");\n";
					_endscriptshtml += "if(typeof tunnelExitInit  === 'function') tunnelExitInit()\n";
			_endscriptshtml += "});\n";
			_endscriptshtml += "</script>";
