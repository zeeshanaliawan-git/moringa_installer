<%@ include file="/WEB-INF/include_r/version.jsp" %>
<style>
<!--
...
<table class="bandcad" cellpadding="0" cellspacing="0" border="0" height="25">
	<tr>
		<td width="110" align="center"><a href="<%=request.getContextPath()%>" class="logo"><%=libelle_msg(Etn,request,"requeteur")%></a>
		<br><b style="color: #9FDCFF;font-size: 8pt;font-style: italic;font-family: trebuchet MS;">v<%=version_requeteur%>&nbsp;(béta)</b>
		...
		<table width="150" cellpadding="0" cellspacing="0" border="0"> 
		  <tr>
		    <td class="bandmess" style="cursor: pointer;" title='Cliquer ici pour sélectionner une requête' onclick="parent.f_liste_requete_en_cours();"><b style="font-weight: bold;font-style: italic;font-size: 8pt;">INBOX</b><!-- onclick="parent.voir();" --> 
		    </td>
		    <td style="vertical-align: bottom;padding-left: 5px;" align="left"><iframe height="19" frameborder="0" id="requete_en_cours" name="requete_en_cours" src="<%=url_requeteur+""%>/requete_en_cours.jsp" marginheight="0" marginwidth="0" scrolling="no" style="width: 280px;margin: 0px;padding: 0px;"></iframe>
		   </td>
		  </tr>
		</table>
