                      ...
                      <table cellpadding="0" cellspacing="0" border="0" width="600">                        
                        ...
                        <tr id="tr_date_f1" <%if(date_f==false){%>style="display:none;"<%}%>>
                         ...
                         String psdate[] = {"","","",""};
                          ...
                          <td class="texte" ><input id="date1" type="text" size="8" value="<%=psdate[0]%>" name="date1"> à <input type="text" name="h1" id="heure_1" value="<%=psdate[1]%>" size="2"></input>&nbsp;<font class="texteaide"><%=libelle_msg(Etn,request,"hh:mm")%></font></td>
                          <td valign="bottom">
                          	<table width="100%">
	                        	 <tr id="tr_date_f5" <%if(date_f==false){%>style="display:none;"<%}%>>
			                          <td class="texte" align="right">au&nbsp;&nbsp;&nbsp;</td>
			                          <td class="texte" height="20" ><input id="date2" type="text" size="8" value="<%=psdate[2]%>" name="date2"> à <input type="text" name="h2"  id="heure_2" value="<%=psdate[3]%>" size="2"></input>&nbsp;<font class="texteaide"><%=libelle_msg(Etn,request,"hh:mm")%></font></td>
			                        </tr>
						...
						<tr id="tr_date_f7" <%if(date_f==false){%>style="display:none;"<%}%>>
                        	...
                        	<td  colspan="3" class="label2" valign="bottom"><input id="multi_psdate" type="text" size="60" value="" name="multi_psdate"> <font class="texteaide"><%=libelle_msg(Etn,request,"dates séparées par des virgules")%></font></td>
                        </tr>
