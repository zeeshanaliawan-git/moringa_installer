...
static final String mots = "/and/or/like/between/not/is/in/null/limit/interval/date_add/distinct/concat/substring/substring_index/locate/" ;
...
int getAtom( Atom a , char b[] , int pos , int len)
{
  ...
  { for( i = pos + 1 ; i < len && isalnum( b[i] ); i++ );
    ...
    if( a.fct == Types.WHEREABLE || a.fct == Types.SELECTABLE ) // voir si OPLOGIQUE
     { if( issql( a.val ) )
       {  a.type = Types.OPLOG;
       ...
       if( a.val.equals("distinct") ){
    	   ...
    	   String val1 = a.val.trim();
    	   if(val1.equalsIgnoreCase("and") || val1.equalsIgnoreCase("or") || val1.equalsIgnoreCase("like") || val1.equalsIgnoreCase("between") || val1.equalsIgnoreCase("not") || val1.equalsIgnoreCase("is") ||
    			   val1.equalsIgnoreCase("null") || val1.equalsIgnoreCase("limit") || val1.equalsIgnoreCase("interval") ){
    		   a.val = " "+a.val+" ";
    	   }else{
    		   a.val = " "+a.val+"";
    	   }
