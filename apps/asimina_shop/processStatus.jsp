...
<div class="c-wrapper c-fixed-components">
		...
		<div style="padding: 15px;">
			...
			<div class="" style="margin-bottom:15px;">
				...
				<div id="legend" style="margin-top: 20px;display: inline-block;">
					...
					<button class="btn btn-info ml-3" onclick="help()" type="button">?</button>
				</div>
	...
	<div id="divGraph" style="border-top:1px solid gray;width:3000px;height:3000px;position: relative;;overflow-x: auto;flex-grow: 1;background-color:white">
	</div>
</div>
                </main>
