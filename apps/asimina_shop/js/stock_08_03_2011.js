...
function editChange( o )
{
	...
	$.ajax({
		type: "POST",
		url: url_save,
		data: "champ="+c+"&valeur="+valeur1+"&cle="+a+"&cle_v="+b+"&tipo="+tipo1[tipo1.selectedIndex].text,
		dataType: "json",
		context : o,
		...
		error:function (xhr, ajaxOptions, thrownError){ 
	            alert("err editChange : "+xhr.responseText);
	        }  
		  }); 
}
...
$('select[class=s]').live('change', function() {
	 //alert("ici")
	 editChange($(this)[0]);
	 });
    } 
