...
<tr>
<td class="htitle" align="center">Upload stock</td>
</tr>
<!-- 
<tr>
...
<fieldset>
<legend class="legend">Upload stock</legend>
...
<script type="text/javascript">
	$(function() {
        $('#file1').change(function() {
            $(this).upload('../js/js-upload/upload_fic.jsp', function(res) {
                ...
                if(res.err==""){
                	...
                	str+= "<br>Ligne de stock terminal correspondante : " + res.ligne_i2;
                	str+= "<br>Ligne de stock autre correspondante : " + res.ligne_i3;
                	str+= "<br>Ligne de SIM correspondante : " + res.ligne_i4;
...
<form action="exemple.jsp" method="post" name="f3" id="f3">
